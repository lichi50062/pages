<%
//95.08.03 create 讀取TC權限 by 2295
//95.08.25 add 金融機構類別/縣市別.總機構單位.受檢單位可個別顯示 by 2295
%>
...
<td width="<%=tc_value_width%>" bgcolor="#EBF4E1" height="1">
   <select size="1" name="bankType" onChange="checkCity();resetOption();changeHsienID('HsienIDXML',form.cityType,form.bankType,form);changeCity('TBankXML', form.tbank, form.cityType, form)">        											  
  ...
  縣市別:&nbsp;&nbsp; 
  <select size="1" name="cityType" onChange="changeCity('TBankXML', form.tbank, form.cityType, form)<%if(showTBank.equals("false")) out.print(";changeOption('BankNoXML',form.examine, form.tbank, 'TBankXML');");%>" >
...
<table border=1 width='100%' align=center bgcolor="#FFFFF" bordercolor="#76C657">
<tr class="sbody">
  <td width="<%=tc_title_width%>" bgcolor="#BDDE9C" height="1">總機構單位</td>
  <td width="<%=tc_value_width%>" bgcolor="#EBF4E1" height="1">           
...
<%//受檢單位================================================================================================================================%>
<span id="examine_div" style="display:<%if(showBank_No.equals("false")) out.print("none;"); else out.print("block;");%>">
<table border=1 width='100%' align=center bgcolor="#FFFFF" bordercolor="#76C657">
<tr class="sbody">
  <td width="<%=tc_title_width%>" bgcolor="#BDDE9C" height="1">受檢單位</td>
  <td width="<%=tc_value_width%>" bgcolor="#EBF4E1" height="1">
