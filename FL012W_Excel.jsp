...
<%@ page import="com.tradevan.util.report.RptFL012W" %>
...
<%
   ...
   String filename="RptFL012W.xls";
   String Unit=( request.getParameter("Unit")==null ) ? "1" : (String)request.getParameter("Unit");			  
   String ex_Type=( request.getParameter("ex_Type")==null ) ? "ALL" : (String)request.getParameter("ex_Type");
   String printStyle = ( request.getParameter("printStyle")==null ) ? "" : (String)request.getParameter("printStyle"); //108.05.28 add
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		...
    		try{
	 			System.out.println("=========call RptFL011W") ;
    			actMsg =RptFL012W.createRpt(ex_Type,Unit);
...
<%!
    private final static String report_no = "FL012W";
