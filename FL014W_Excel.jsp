...
<%@ page import="com.tradevan.util.report.RptFL014W" %>
   ...
   String filename="RptFL014W.xls";
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		...
    		try{
	 			System.out.println("=========call RptFL014W") ;
    			actMsg =RptFL014W.createRpt();
...
<%!
    private final static String report_no = "FL014W";
