<%
//94.03.15 存放款統計表(FR040WW)--總表/明細表 by 4180
//99.03.26 fix 取得該功能項目權限移至Utility.getPermission by 2295
//99.09.17 add 套用查詢日期模組 by 2295
...
function doSubmit(){       
   ...
   if(confirm("本項報表會報行10-15秒，是否確定執行？"))
   {
   		if(this.document.forms[0].rptStyle.value == "0"){//總表   			 
   			 this.document.forms[0].action = "/pages/FR040WW_Excel.jsp";
   		} 
   		if(this.document.forms[0].rptStyle.value == "1"){//明細表   			 		 
   			 this.document.forms[0].action = "/pages/FR040WA_Excel.jsp";
   		}  		
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="40%"><font color='#000000' size=4><b><center><%=title%>存放款統計表</center></b></font></td>
    <td width="30%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
<table border="1" width="600" align="center" height="85" bgcolor="#FFFFF" bordercolor="#76C657">
