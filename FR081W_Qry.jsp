...
function doSubmit(){ 
   ...
   if(confirm("本項報表會報行10-15秒，是否確定執行？")){
      this.document.forms[0].action = "/pages/FR081W_Excel.jsp";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="70%"><font color='#000000' size=4><b><center>全體農漁會信用部各身分別存款金額一覽表</center></b></font></td>
    <td width="15%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
