...
<%
	...
	System.out.println("TC55_Edit.sztbank_no="+sztbank_no);
	
	List EXACTNOF = (List)request.getAttribute("EXACTNOF");		
	String title="處理意見";			
	...
	if(permission == null){
       System.out.println("TC55_Edit.permission == null");
    }else{
       System.out.println("TC55_Edit.permission.size ="+permission.size());          
    }
%>
			...
			<table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="sbody">
						<td width='15%' align='left' bgcolor='#BDDE9C'>處理意見代碼</td>
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
                          	<%if(act.equals("Edit")){%>
                          		<input type='hidden' name='ACT_ID' value="<%if(EXACTNOF != null && EXACTNOF.size() != 0 && ((DataObject)EXACTNOF.get(0)).getValue("act_id") != null ) out.print((String)((DataObject)EXACTNOF.get(0)).getValue("act_id"));%>">
  		                     	<%if(EXACTNOF != null && EXACTNOF.size() != 0 && ((DataObject)EXACTNOF.get(0)).getValue("act_id") != null ) out.print((String)((DataObject)EXACTNOF.get(0)).getValue("act_id"));%>
                            <%}else{%>
                            	<input type='text' name='ACT_ID' value="<%if(EXACTNOF != null && EXACTNOF.size() != 0 && ((DataObject)EXACTNOF.get(0)).getValue("act_id") != null ) out.print((String)((DataObject)EXACTNOF.get(0)).getValue("act_id"));%>" size='4' maxlength='4'>
                            <%}%>
                          </td>
                          </tr>     
						  ...
						  <td width='85%' colspan=2 bgcolor='EBF4E1'>
  		                    <input type='text' name='ACT_NAME' value="<%if(EXACTNOF != null && EXACTNOF.size() != 0 && ((DataObject)EXACTNOF.get(0)).getValue("act_id") != null ) out.print((String)((DataObject)EXACTNOF.get(0)).getValue("act_name"));%>" size='50' maxlength='100'>                                                                              						                              
                          </td>
                          </tr>                             
                ...
                <td><table width="560" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    ...
                    <tr> 
                      ...
                      <td width="520"> <ul>                                            
                          ...
                          <li>按<font color="#666666">【回上一頁】</font>則放棄新增處理意見代碼, 回至上個畫面。</li>
                        </ul></td>
                    </tr>
                  </table></td>
              </tr>
