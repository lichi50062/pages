...
<td width="<%=tc_value_width%>" bgcolor="#EBF4E1" height="1">
   <select size="1" name="bankType" onChange="checkCity();resetOption_TC36();changeHsienID('HsienIDXML',form.cityType,form.bankType,form);changeCity_TC36('TBankXML','BankNoXML', form.tbank, form.cityType, form)">        											  
  ...
  縣市別:&nbsp;&nbsp; 
  <select size="1" name="cityType" onChange="changeCity_TC36('TBankXML','BankNoXML', form.tbank, form.cityType, form)<%if(showTBank.equals("false")) out.print(";changeOption('BankNoXML',form.examine, form.tbank, 'TBankXML');");%>" >
