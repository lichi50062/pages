...
<%
    ...
    if(permission == null){
       System.out.println("MC002W_Edit.permission == null");
    }else{
       System.out.println("MC002W_Edit.permission.size ="+permission.size());
    }			
    System.out.println("Page: MC002W_Edit.jsp    Action:"+act);

    String tbank="",bank_name="",come_date="",come_docno="",sn_date="",sn_docno="",pre_sn_docno="",content="";
    ...
    if(act.equals("New")) { 
     ...
     // XML Ducument for 總機構代碼 end 
        ...
        if(bean != null) {
            ...
            pre_sn_docno = bean.getValue("pre_sn_docno") != null ? (String) bean.getValue("pre_sn_docno") : "";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           ...
           <td width="50%"><font color='#000000' size=4><b><center>信用部防制洗錢注意事項修正</center></b></font> </td>
           <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
         </tr>
</table>
...
<td width="416" bgcolor="#EBF4E1" height="1">
 <select size="1" name="bankType" onChange="changeOption('TBankXML',form.tbank, form.bankType, 'TBankXML')">
...
<tr class="sbody">
  ...
  <%}else{%>
   <input type="hidden" name="come_docno" size="10" maxlength=10 value="<%=come_docno%>">  
   <%=come_docno%>
  <%}%>
  </td>
</tr>   
...
<tr class="sbody">
  ...
  <%}else{%>
   <input type="hidden" name="sn_docno" size="10" maxlength=10 value="<%=sn_docno%>">  
   <%=sn_docno%>
  <%}%>
  </td>
</tr>   
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">函請修正發文文號</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
   <input type="text" name="pre_sn_docno" size="10" value="<%=pre_sn_docno%>">
  </td>
</tr>   
<tr class="sbody">
  ...
  <select size="1" name="content" >
    ...
    <option value="02" <%if(content.equals("02")) out.print("selected");%>>應修改</option>
  </select> </td>
</tr>
</Table>
