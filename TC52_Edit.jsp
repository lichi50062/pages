...
<%
	...
	System.out.println("TC52_Edit.sztbank_no="+sztbank_no);
	
	List EXPERTNOF = (List)request.getAttribute("EXPERTNOF");		
	String title="專長代碼";			
	...
	if(permission == null){
       System.out.println("TC52_Edit.permission == null");
    }else{
       System.out.println("TC52_Edit.permission.size ="+permission.size());
                ...
                <td><table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="sbody">
						...
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
                          	<%if(act.equals("Edit")){%>
                          		<input type='hidden' name='EXPERTNO_ID' value="<%if(EXPERTNOF != null && EXPERTNOF.size() != 0 && ((DataObject)EXPERTNOF.get(0)).getValue("expertno_id") != null ) out.print((String)((DataObject)EXPERTNOF.get(0)).getValue("expertno_id"));%>">
  		                     	<%if(EXPERTNOF != null && EXPERTNOF.size() != 0 && ((DataObject)EXPERTNOF.get(0)).getValue("expertno_id") != null ) out.print((String)((DataObject)EXPERTNOF.get(0)).getValue("expertno_id"));%>
                            <%}else{%>
                            	<input type='text' name='EXPERTNO_ID' value="<%if(EXPERTNOF != null && EXPERTNOF.size() != 0 && ((DataObject)EXPERTNOF.get(0)).getValue("expertno_id") != null ) out.print((String)((DataObject)EXPERTNOF.get(0)).getValue("expertno_id"));%>" size='4' maxlength='4'>
                            <%}%>
                          </td>
                          </tr>     
						  ...
						  <td width='85%' colspan=2 bgcolor='EBF4E1'>
  		                    <input type='text' name='EXPERTNO_NAME' value="<%if(EXPERTNOF != null && EXPERTNOF.size() != 0 && ((DataObject)EXPERTNOF.get(0)).getValue("expertno_id") != null ) out.print((String)((DataObject)EXPERTNOF.get(0)).getValue("expertno_name"));%>" size='50' maxlength='100'>                                                                              						                              
                          </td>
                          </tr>                             
