<%
//100.07.08 create 市場風險資本扣除項目彙總(6-G) by 2295
//108.06.03 add 報表格式轉換 by rock.tsai
//108.06.13 fix 處理檔案下載時,用另存附件檔 by 2295
...
<%
	...
	try{	      	
			...
			//String titleName += Utility.getPgName("DS051W");			
			titleName += "市場風險資本扣除項目彙總(6-G)";	  		
			//年
        ...
        for(i=0;i<btnFieldList_data.size();i++){
            ...
            for(i=0;i<btnFieldList_data.size();i++){
                ...
                //   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("003000") ||
                //   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("004000") ||                  
                //   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("005000")){
