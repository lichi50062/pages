...
//111.03.29 WLX06_M_OUTPUSH.OutCompany+受委託機構/WLX06_M_OUTPUSH.BankComplain+信用部申訴窗口,才合併橫向欄位 by 2295
...
<%
   ...
   String printStyle = "";//輸出格式 108.04.02add 	     
   //輸出格式 108.04.02 add
		...
		wlx01.append(" HSIEN_DIV_1,CANCEL_NO,CANCEL_DATE from wlx01 where m_year =? )");
            ...
            */
            ...
            for(i=0;i<btnFieldList_data.size();i++){
               ...
               if(((String)((List)btnFieldList_data.get(i)).get(0)).equals("WLX06_M_OUTPUSH.OutCompany") || ((String)((List)btnFieldList_data.get(i)).get(0)).equals("WLX06_M_OUTPUSH.BankComplain")){//111.03.29 WLX06_M_OUTPUSH.OutCompany+受委託機構/WLX06_M_OUTPUSH.BankComplain+信用部申訴窗口,才合併橫向欄位
