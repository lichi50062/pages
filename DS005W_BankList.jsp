...
//111.03.24 調整Edge無法挑選縣市別/金融機構代碼無資料可挑選 by 2295
//111.03.24 調整Edge可選擇項目,dbclick時無法將項目移至已選擇項目 by 2295
//111.03.24 調整Edge>.>>.<.<<及上移.下移無作用 by 2295
%>
...
<%
	...
	String ds_memo1 = "選取[各信用部]：按「資本適足率明細資料」的報表內容列印";//108.04.25 add		
	String ds_memo2 = "";//108.04.25 add		
