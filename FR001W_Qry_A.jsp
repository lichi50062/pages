...
//94.08.08 add 年月不可小於94年6月 by 2295
...
<%
	Calendar rightNow = Calendar.getInstance();
 	...
 	//取得FR001W的權限
	Properties permission = ( session.getAttribute("FR001W_A")==null ) ? new Properties() : (Properties)session.getAttribute("FR001W_A"); 
	if(permission == null){
       System.out.println("FR001W_Qry.permission == null");
    }else{
       System.out.println("FR001W_Qry.permission.size ="+permission.size());               
    }
%>
...
function doSubmit(){      
   ...
   this.document.forms[0].action = "/pages/FR001W_Excel_A.jsp";	
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600"><%=title%>信用部經營指標表A</font>
                  </center>
                  </font> </td>
                <td width="200"><img src="images/banner_bg1.gif" width="200" height="17"></td>
              </tr>
                    ...
                    <tr> 
                      <td bgcolor="#B0D595" class="sbody"> <div align="right">
                          <input type='radio' name="act" value='view' checked>檢視報表
                      	  <input type='radio' name="act" value='download'>下載報表  
