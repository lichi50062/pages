<%
// 95/01/03 create by 4180 台灣區農會信用部支票存款戶數與餘額明細表
...
<%
	...
	sqlCmd += " and bn01.bank_no = wlx01.bank_no order by wlx01.hsien_id,bn01.bank_no";
				  
    List tbankList = DBManager.QueryDB_SQLParam(sqlCmd,paramList,"");
    
    //取得FR030WA的權限
	Properties permission = ( session.getAttribute("FR030WA")==null ) ? new Properties() : (Properties)session.getAttribute("FR030WA"); 
	if(permission == null){
       System.out.println("FR030WA_BankList.permission == null");
    }else{
       System.out.println("FR030WA_BankList.permission.size ="+permission.size());               
    }	
...
<script language="javascript" src="js/FR030WA.js"></script>
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="400"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600">台灣區<%=title%>信用部支票存款戶數與餘額明細表</font>
                  </center>
                  </font> </td>
                <td width="100"><img src="images/banner_bg1.gif" width="100" height="17"></td>
              </tr>
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("FR034W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
