<%
//95/01/03 by 4180 台灣區農會信用部支票存款戶數與餘額明細表
%>
...
<%
	...
	if(session.getAttribute("muser_id") == null){//session timeout		
      System.out.println("FR030WA login timeout");   
...
<%!
    ...
    private final static String BankListPgName = "/pages/FR030WA_Qry.jsp";          
    private final static String RptCreatePgName = "/pages/FR030WA_Excel.jsp";        
    ...
    private boolean CheckPermission(HttpServletRequest request){//檢核權限    	    
            ...
            if(permission == null){
              System.out.println("FR030WA.permission == null");
            }else{
               System.out.println("FR030WA.permission.size ="+permission.size());
