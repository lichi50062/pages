...
<%
	...
	try{
			...
			sqlCmd.append("        		decode(field_loan_bal_amt,0,0,round(field_over6m_loan_bal_amt / field_loan_bal_amt *100 ,2))  as   field_over_rate,");
			...
			sqlCmd.append("               		round(sum(agri_loan.over6m_loan_bal_cnt) /1,0) as field_over6m_loan_bal_cnt,");
	    	...
	    	titleStyle = HssfStyle.setStyle( title_style, wb.createFont(),
	                                     new String[] {
	                                     "PHC", "PVC", "F20"} );
            ...
            for(i=0;i<dbData.size();i++){            
                ...
                for(int cellIdx =4;cellIdx < (new Short(lastCellNum)).intValue();cellIdx++){                    
                     ...
                     if(!(amt_type.equals("4") || "over6m_loan_bal_cnt".equals(tmpStr))){//該值不為利率或戶數時.再除以單位4捨五入
