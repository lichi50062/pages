<%
//102.06.24 add 警示報表UserProgram by 2295
%>
...
<%
    ...
    sqlCmd = " select  WTT03_1.program_id,WTT03_1.PROGRAM_NAME,WTT03_1.url_id,"
		   ...
		   + " and (WTT03_1.program_id like 'WR%')";		   
...
<td>&nbsp;&nbsp;<font color='red' size='2px'><b>營運狀況警示報表</b></font></td>
<script>
<%   
out.println("foldersTree = gFld('<font size=2>警示報表</font>', ' ');");//95.10.16當沒有權限時,預設顯示該資料夾                          
System.out.println("WR000 -- print initializeDocument");
