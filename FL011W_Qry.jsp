...
function doSubmit(){   
	this.document.forms[0].action = "/pages/FL011W_Excel.jsp?act=download";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="60%"><font color='#000000' size=4><b><center>逾期未函報政策性農業專案貸款缺失改善情形農漁會明細查詢表</center></b></font></td>
    <td width="20%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
