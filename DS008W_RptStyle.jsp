...
<%
	...
	System.out.println("DS008W_RptStyle.szExcelAction="+szExcelAction);
	...
	//取得DS008W的權限
	Properties permission = ( session.getAttribute("DS008W")==null ) ? new Properties() : (Properties)session.getAttribute("DS008W"); 
	if(permission == null){
       System.out.println("DS008W_RptStyle.permission == null");
    }else{
       System.out.println("DS008W_RptStyle.permission.size ="+permission.size());               
    }	
        ...
        <tr> 
          <td width="824"><table width="797" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="280" class="title_font">金融卡發卡及ATM裝設情形 </td>
                <td width="240"><img src="images/banner_bg1.gif" width="240" height="17"></td>
              </tr>
            </table></td>
        </tr>
