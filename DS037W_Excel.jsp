<%
//100.07.20 create 表外項目信用約當金額－標準法(創始銀行)(4-D-2) by 2295      
//101.10.12 fix 增修部份欄位 by 2295
...
<%
	...
	try{	      	
			...
			titleName += "表外項目信用約當金額－標準法(創始銀行)(4-D-2)";	  		
			//年
