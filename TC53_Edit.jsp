...
<%
	...
	System.out.println("TC53_Edit.sztbank_no="+sztbank_no);
	
	List EXBASISNOF = (List)request.getAttribute("EXBASISNOF");		
	String title="檢查依據代號";			
	...
	if(permission == null){
       System.out.println("TC53_Edit.permission == null");
    }else{
       System.out.println("TC53_Edit.permission.size ="+permission.size());
                ...
                <td><table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="sbody">
						...
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
                          	<%if(act.equals("Edit")){%>
                          		<input type='hidden' name='BASIS_ID' value="<%if(EXBASISNOF != null && EXBASISNOF.size() != 0 && ((DataObject)EXBASISNOF.get(0)).getValue("basis_id") != null ) out.print((String)((DataObject)EXBASISNOF.get(0)).getValue("basis_id"));%>">
  		                     	<%if(EXBASISNOF != null && EXBASISNOF.size() != 0 && ((DataObject)EXBASISNOF.get(0)).getValue("basis_id") != null ) out.print((String)((DataObject)EXBASISNOF.get(0)).getValue("basis_id"));%>
                            <%}else{%>
                            	<input type='text' name='BASIS_ID' value="<%if(EXBASISNOF != null && EXBASISNOF.size() != 0 && ((DataObject)EXBASISNOF.get(0)).getValue("basis_id") != null ) out.print((String)((DataObject)EXBASISNOF.get(0)).getValue("basis_id"));%>" size='4' maxlength='4'>
                            <%}%>
                          </td>
                          </tr>     
						  ...
						  <td width='85%' colspan=2 bgcolor='EBF4E1'>
  		                    <input type='text' name='BASIS_NAME' value="<%if(EXBASISNOF != null && EXBASISNOF.size() != 0 && ((DataObject)EXBASISNOF.get(0)).getValue("basis_id") != null ) out.print((String)((DataObject)EXBASISNOF.get(0)).getValue("basis_name"));%>" size='50' maxlength='100'>                                                                              						                              
                          </td>
                          </tr>                             
