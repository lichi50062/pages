<%
//108.05.02 add 報表格式轉換/所有欄位移至DS_bank_no_all.include(因多個include會造成多列空白) by 2295  
...
<%
	...
	String ds_memo1 = "(1)選取[各信用部]：按「"+title+"」的報表內容列印";//108.05.02 add
	String ds_memo2 = "";//108.05.02 add	
