...
//108.12.27 fix FR024W改檔案名稱全體農會信用部逾放比率超逾百分之5明細表 by 2295
...
<%!
    ...
    private final static String[][] rptfilename = {												  
											      ...
											      {"FR024W_STDET", "全體農會信用部逾放比率超逾百分之5明細表.xls"},//108.12.27 調整檔名 by 2295
	        	...
	        	if(!ClientRptDir.exists()){
		  		...
		  		if(errMsg.equals("")){			  		   
         		   ...
         		   if(updateDBList.size() >= 1){         		       
		               ...
		               MySFTPClient msftp = new MySFTPClient(rptIP, rptID, rptPwd);//110.06.29 add 調整使用SFTP上傳
		               
                       boolean uploadSuccess = false;//110.05.06 add
                       if(rptDir.exists() && rptDir.isDirectory()){
		                  ...
		                  //MyFTPClient ftpC = new MyFTPClient(rptIP, rptID, rptPwd);//110.06.29 取消使用FTP   
