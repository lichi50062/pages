...
function doSubmit(cnd){   
	   this.document.forms[0].action = "/pages/FR071W_Excel.jsp?act=download";	
	   this.document.forms[0].target = '_self';
	   this.document.forms[0].submit();   
}
//94.03.10 add by egg
//重導FR071W_Qry.jsp頁面以致輸出對應之金融機構資料
function getData(form,item){
	if(item == 'cancel_no'){
		//初始BANK_NO值
	   	form.BANK_NO.value="";
	}
	form.action="/pages/FR071W_Qry.jsp?act=getData&test=nothing";
	form.submit();
}
