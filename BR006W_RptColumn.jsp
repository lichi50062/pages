...
//99.12.27 add 報表欄位.可挑選項目套用共用include by 2295
...
<%
	...
	//System.out.println("BR006W_RptColumn.szExcelAction="+szExcelAction);
	System.out.println("BR006W_RptColumn.position_code="+position_code);	
%>
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr>
                      <td bgcolor="#E9F4E3"> <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr class="sbody">
                          <%
                          List position_code_data = DBManager.QueryDB_SQLParam("select * from cdshareno where cmuse_div='007'",null,""); 
                          %>
