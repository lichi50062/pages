...
<%
	...
	System.out.println("FR036W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("FR036W_BankList.hsien_id="+hsien_id);
    ...
    //取得FR036W的權限
	Properties permission = ( session.getAttribute("FR036W")==null ) ? new Properties() : (Properties)session.getAttribute("FR036W"); 
	if(permission == null){
       System.out.println("FR036W_BankList.permission == null");
    }else{
       System.out.println("FR036W_BankList.permission.size ="+permission.size());               
    }	
...
<script language="javascript" src="js/FR036W.js"></script>
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="300"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600">全體<%=title%>信用部統一貸款資料明細表_單月_明細表及總表</font>
                  </center>
                  </font> </td>
                <td width="150"><img src="images/banner_bg1.gif" width="200" height="17"></td>
              </tr>
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("FR036W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
