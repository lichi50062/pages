...
<%
    ...
    String title = "N年內及目前月份資本適足率家數統計";
%>
...
function doSubmit(){ 
	if(this.document.forms[0].S_YEAR1.value==""){
		...
		this.document.forms[0].action = "/pages/FR067W_Excel.jsp";	
...
<tr class="sbody">
<td width="118" bgcolor="#BDDE9C" height="1" class="sbody">資本適足率(BIS)區間</td>
<td width="416" bgcolor="#EBF4E1" height="1">
   <input type="text" name="S_YEAR4" size="7" maxlength="3" onkeypress="event.returnValue=IsNum()" value='0'>% ≦ 
   <input type="text" name="S_YEAR3" size="7" maxlength="3" onkeypress="event.returnValue=IsNum()" value='6'>% ≦ &nbsp;
   <input type="text" name="S_YEAR2" size="7" maxlength="3" onkeypress="event.returnValue=IsNum()" value='8'>% </td> 
</tr>
