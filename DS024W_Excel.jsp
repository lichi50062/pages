<%
//99.09.06 create 信用風險加權風險性資產、作業風險暨市場風險資本計提彙總表(1-C) by 2295
...
<%
	...
	try{	      	
			...
			titleName += "信用風險加權風險性資產作業風險暨市場風險資本計提彙總表(1-C)";		  		
			//年
            ...
            //wb.setSheetName(0, Utility.ISOtoBig5(titleName), HSSFWorkbook.ENCODING_UTF_16 );
            wb.setSheetName(0, "1-C", HSSFWorkbook.ENCODING_UTF_16 );
