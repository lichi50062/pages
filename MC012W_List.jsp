...
<%
	...
	System.out.println("Page: MC012W_List.jsp    Action:"+act);
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           ...
           <td width="30%"><font color='#000000' size=4><b><center>舞弊案件查詢</center></b></font> </td>
...
<td width="416" bgcolor="#EBF4E1" height="1">
  ...
  <a href="/pages/MC012W.jsp?act=New" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image102','','images/bt_addb.gif',1)">
...
<Table border="1" width="100%"  bgcolor="#FFFFF" bordercolor="#76C657">
      <tr class="sbody" bgcolor="#BFDFAE">
        ...
        <td width="15%" height="14">舞弊人</td>
        <td width="25%" height="14">舞弊機構</td>
        <td width="35%" height="14">舞弊內容</td> 
      </tr>
      ...
      <tr class="sbody" bgcolor='<%=(i % 2 == 0)?"#EBF4E1":"#FFFFCC"%>'>
        <td width="15%" height="1"><a href=MC012W.jsp?act=Edit&bank_no=<%=bean.getValue("bank_no")%>&emNum=<%=bean.getValue("em_number")%>&emNo=<%=bean.getValue("em_no")%>><%=bean.getValue("em_number")%></a>&nbsp;</td>
        <td width="10" height="1"><%=bean.getValue("em_date") != null ? bean.getValue("em_date") : "&nbsp;"%></td>
        <td width="15%" height="1"><%=bean.getValue("em_emer") != null ? bean.getValue("em_emer") : "&nbsp;"%></td>
        ...
        <td width="35%" height="1"><%=bean.getValue("em_content") != null ? bean.getValue("em_content") : "&nbsp;"%></td>
      </tr>
      <%        }
     }else {%>            
    ...
    <td width="97%"> 
      <ul>                                                
        ...
        <% } else if(act.equals("Qry")) {%>
            <li>本網頁提供舞弊案件查詢功能。</li>
            <li>按<font color="#666666">【查詢】</font>則依查詢條件值查詢資料。</li> 
		    <li>按<font color="#666666">【來文文號】連結</font>則可查看此筆資料。</li>
