...
<%
    ...
    String report_no  = "FR030WW" ;
	//查詢年月(前一個月份)
	String YEAR  = Utility.getYear();
	String MONTH = Utility.getMonth();
	List tBankList = Utility.getALLTBank(bank_type) ;
	...
	System.out.println("FR030WW_BankList.szExcelAction="+szExcelAction);
	String cityType = ( session.getAttribute("cityType")==null ) ? "ALL" : (String)session.getAttribute("cityType");				
	System.out.println("FR030WW_BankList.cityType="+cityType);
...
<script language="javascript" src="js/FR030WW.js"></script>
...
function ResetAllData(){
    if(confirm("確定要清除已選定的資料嗎？")){  	
        ...
        this.document.forms[0].cityType[0].selected=true;	   
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="70%"><font color='#000000' size=4><center><%=title%>信用部支票存款戶數與餘額統計報表 </center></font></td>
    <td width="15%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                      ...
                      <td bgcolor="#E9F4E3"> <table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr class="sbody">
                     		<td>
								...
								<span class="mtext">報表格式 :</span>
	                            <select size="1" name="report_type" onchange="javascript:hiddenYM(this.document.forms[0]);">                   
		                            <option value ='2' selected>信用部支票存款戶數與餘額明細表</option>
		                            <option value ='3'>信用部支票存款戶數與餘額總表</option>
		                            <option value ='1'>信用部支票存款戶數與餘額統計表</option>
                          		</select>
        					</td>
                    	</tr>
                    ...
                    <tr class="sbody">  
                       <td><img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">縣市別 :</span>                                
                           <select size="1" name="cityType" onchange="javascript:clearSelectBlock();changeOption(document.forms[0],'');" />
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("FR030WW_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
