<%
//98.06.09 create 全體農漁會信用部各會員別放款金額一覽表 by 2295
...
<%
   ...
   String bank_code = Utility.getTrimString(dataMap.get("BANK_NO"));   
   ...
   String filename="全體農漁會信用部各會員別放款金額一覽表.xls";
  
   System.out.println("FR054W_Excel.S_YEAR="+S_YEAR);
   System.out.println("FR054W_Excel.act="+act);   
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
		...
		if(act.equals("Qry")){
   		...
   		if(act.equals("view") || act.equals("download")){
   			try{
				actMsg =RptFR054W.createRpt(S_YEAR,S_MONTH,Unit,"",null);
...
<%!
    private final static String report_no = "FR054W";
