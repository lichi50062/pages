...
<%
	...
	System.out.println("TC54_Edit.sztbank_no="+sztbank_no);
	
	List EXFAULTF = (List)request.getAttribute("EXFAULTF");		
	String title="檢查意見代碼";			
	...
	if(permission == null){
       System.out.println("TC54_Edit.permission == null");
    }else{
       System.out.println("TC54_Edit.permission.size ="+permission.size());
			...
			<table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="sbody">
						<td width='15%' align='left' bgcolor='#BDDE9C'>檢查意見代碼</td>
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
                          	<%if(act.equals("Edit")){%>
                          		<input type='hidden' name='FAULT_ID' value="<%if(EXFAULTF != null && EXFAULTF.size() != 0 && ((DataObject)EXFAULTF.get(0)).getValue("fault_id") != null ) out.print((String)((DataObject)EXFAULTF.get(0)).getValue("fault_id"));%>">
  		                     	<%if(EXFAULTF != null && EXFAULTF.size() != 0 && ((DataObject)EXFAULTF.get(0)).getValue("fault_id") != null ) out.print((String)((DataObject)EXFAULTF.get(0)).getValue("fault_id"));%>
                            <%}else{%>
                            	<input type='text' name='FAULT_ID' value="<%if(EXFAULTF != null && EXFAULTF.size() != 0 && ((DataObject)EXFAULTF.get(0)).getValue("fault_id") != null ) out.print((String)((DataObject)EXFAULTF.get(0)).getValue("fault_id"));%>" size='4' maxlength='4'>
                            <%}%>
                          </td>
                          </tr>     
						  ...
						  <td width='85%' colspan=2 bgcolor='EBF4E1'>
  		                    <input type='text' name='FAULT_NAME' value="<%if(EXFAULTF != null && EXFAULTF.size() != 0 && ((DataObject)EXFAULTF.get(0)).getValue("fault_id") != null ) out.print((String)((DataObject)EXFAULTF.get(0)).getValue("fault_name"));%>" size='50' maxlength='100'>                                                                              						                              
                          </td>
                          </tr>                             
                ...
                <td><table width="560" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    ...
                    <tr> 
                      ...
                      <td width="520"> <ul>                                            
                          ...
                          <li>按<font color="#666666">【回上一頁】</font>則放棄新增檢查意見代碼, 回至上個畫面。</li>
                        </ul></td>
                    </tr>
                  </table></td>
              </tr>
