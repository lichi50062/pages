...
<%
	System.out.println("@@TC15_List.jsp Start...");
	...
	System.out.println("TC15_List.sztbank_no="+sztbank_no);	
	List BA01List = (List)request.getAttribute("BA01List");		
	if(BA01List == null){
	   System.out.println("BA01List == null");
	}else{
	   System.out.println("BA01List.size()="+BA01List.size());
	}
	...
	if(permission == null){
       System.out.println("TC15_List.permission == null");
    }else{
       System.out.println("TC15_List.permission.size ="+permission.size());               
    }	
%>
                ...
                <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
					      ...
					      <tr class="sbody">
						  <td width='15%' align='left' bgcolor='#D8EFEE'>總/分支機構</td>						  
						  <td width='85%' colspan=2 bgcolor='e7e7e7'>
						  	<select name='BANK_KIND'><option value="0">總機構<option value="1">分支機構<option value="2">全部</select>
                          </td>
                          </tr>
					      <tr class="sbody">
						  <td width='20%' align='left' bgcolor='#D8EFEE'>金融總機構代碼</td>						  
						  <td width='80%' colspan=2 bgcolor='e7e7e7'>
						    <input type='text' name='BANK_NO' value="<%=sztbank_no%>" size='7' maxlength='7' >
                          </td>
                          </tr>   
                          </table>      
                      </td>    
                      ...
                      if(BA01List != null){ %>
                            ...
                            <td width="120">機構號碼</td>
            				<td width="200">機構名稱</td>
            				<td width="100">總/分支機構</td>            				
					      </tr>   
                   		    <% if(BA01List.size() == 0){%>
                   			   ...
                   			   <tr>                   			   
                   			<% }
                    		   while(i < BA01List.size()){ 
                    		      bgcolor = (i % 2 == 0)?"#e7e7e7":"#D3EBE0";	                    		      
                      %>                         	  
                          <tr class="sbody" bgcolor="<%=bgcolor%>">
            				<td width="120"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)BA01List.get(i)).getValue("bank_no")%>');"><%if( ((DataObject)BA01List.get(i)).getValue("bank_no") != null ) out.print((String)((DataObject)BA01List.get(i)).getValue("bank_no")); else out.print("&nbsp;");%></a></td>
            				<td width="200"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)BA01List.get(i)).getValue("bank_no")%>');"><%if( ((DataObject)BA01List.get(i)).getValue("bank_name") != null ) out.print((String)((DataObject)BA01List.get(i)).getValue("bank_name")); else out.print("&nbsp;");%></a></td>
            				<td width="100"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)BA01List.get(i)).getValue("bank_no")%>');">
            				<%if( ((DataObject)BA01List.get(i)).getValue("bank_kind") != null ) {
            					String kind_name="";
            					if (((String)((DataObject)BA01List.get(i)).getValue("bank_kind")).equals("0")){
            						kind_name="總機構";
            					}else {
            						kind_name="分支機構";
            					}
...
<%System.out.println("@@TC15_List.jsp End...");%>