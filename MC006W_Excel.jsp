   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
   				    if(rptStyle.equals("2")){
   				       actMsg =RptFR051W.createRpt(rptStyle,RptYear,"",tbank);	    			
   				    }else{
	    			   actMsg =RptFR051W.createRpt(rptStyle,RptYear,cityType,tbank);	    			
	    			}
...
<%!
    private final static String report_no = "MC006W" ;
