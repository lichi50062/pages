...
//99.05.17 fix 套用共用畫面DS_RptStyle.include by 2808
%>
...
<%
	...
	System.out.println("DS007W_RptStyle.szExcelAction="+szExcelAction);
        ...
        <tr> 
          <td width="824"><table width="797" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="340" class="title_font">F01在台無住所之外國人新台幣存款表 </td>
                <td width="210"><img src="images/banner_bg1.gif" width="210" height="17"></td>
              </tr>
            </table></td>
        </tr>
