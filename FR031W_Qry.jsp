...
<%     
   ...
   if(session.getAttribute("muser_id") == null){//session timeout		
      System.out.println("FR031W login timeout");   
...
<%
	...
	String S_YEAR = String.valueOf(rightNow.get(Calendar.YEAR)-1912);
	String S_MONTH = "01";
...
<form name='FR031W' method=post action='FR031W_Excel.jsp'>
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="300"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600">農業信用保證基金業務統計（一）</font>
                  </center>
                  </font> </td>
                <td width="50"><img src="images/banner_bg1.gif" width="150" height="17"></td>
              </tr>
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    <tr> 
                      <td bgcolor="#B0D595" class="sbody"> <div align="right">
                          ...
                          <a href="javascript:chInput(FR031W);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image411','','images/bt_execb.gif',1)"><img src="images/bt_exec.gif" name="Image411" width="66" height="25" border="0" id="Image41"></a> 
