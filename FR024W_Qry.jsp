...
<%
	Calendar rightNow = Calendar.getInstance();
 	...
 	String title=(bank_type.equals("6"))?"全體農會信用部逾放比率超逾5%明細表":"全體漁會信用部逾放比率超逾5%明細表";
 	//取得FR024W的權限
	Properties permission = ( session.getAttribute("FR024W")==null ) ? new Properties() : (Properties)session.getAttribute("FR024W"); 
	if(permission == null){
       System.out.println("FR024W_Qry.permission == null");
    }else{
       System.out.println("FR024W_Qry.permission.size ="+permission.size());               
    }
%>
...
function doSubmit(){      
   ...
   {	   
	this.document.forms[0].action = "/pages/FR024W_Excel.jsp";	
	...
	<table width="600" border="0" align="center" cellpadding="1" cellspacing="1">        
        <tr> 
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="120"><img src="images/banner_bg1.gif" width="120" height="17"></td>
