...
<%	
    ...
    String exam_div = Utility.getTrimString(dataMap.get("exam_div")) ;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           ...
           <td width="50%"><font color='#000000' size=4><b><center>檢查行程計劃查詢 </center></b></font> </td>
           <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
         </tr>
</table>
...
<td width="416" bgcolor="#EBF4E1" height="4">
  <input type="text" name="disp_id" size="20" maxlength="7" value='<%=disp_id%>'>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br><font color="#FF0000">如要新增, 請先輸入派差通知單編號再按新增</font>
</td> 
</tr>
<tr class="sbody">
...
<tr class="sbody">
<td width="118" bgcolor="#BDDE9C" height="1">檢查基準日期</td>
...
<td width="416" bgcolor="#EBF4E1" height="1">
   <select size="1" name="bankType" onChange="resetOption();changeTbank('TBankXML',form.begY);checkCity();">
...
<td width="416" bgcolor="#EBF4E1" height="1">           
  <select size="1" name="tbank" onChange="changeOption('BankNoXML',form.examine, form.tbank, 'TBankXML')">
...
if(act.equals("Qry")) {%>
<tr class="sbody">
<td width="100%" bgcolor="#9AD3D0" colspan="2" valign='top'>
    <table border="1" width="100%" bgcolor="#FFFFF" bordercolor="#76C657" >
      <tr class="sbody"   bgcolor="#BFDFAE">
        ...
        <td width="20%" align='center'>檢查基準日期</td>
      ...
      <tr class="sbody" bgcolor='<%=(i % 2 == 0)?"#EBF4E1":"#FFFFCC"%>' >
        ...
        <td width="20%"  align='center'>&nbsp;<%=bean.getValue("base_date") != null ? bean.getValue("base_date") : ""%></td>
...
<tr class="sbody"><th>
&nbsp; 
<input type='hidden' name='BANK_CODE' value=001>   
<input type='hidden' name='SERIAL_NO' value=13>    
</th></tr></Table>
