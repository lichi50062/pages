...
<%@ page import="com.tradevan.util.report.RptFL016W" %>
   ...
   String filename="RptFL016W.xls";
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		...
    		try{
	 			System.out.println("=========call RptFL016W") ;
...
<%!
    private final static String report_no = "FL016W";
