...
<%
    ...
    Properties permission = ( session.getAttribute("MC013W")==null ) ? new Properties() : (Properties)session.getAttribute("MC013W");
    if(permission == null){
       System.out.println("MC013W_Edit.permission == null");
    }else{
       System.out.println("MC013W_Edit.permission.size ="+permission.size());
    }			
    System.out.println("Page: MC013W_Edit.jsp    Action:"+act);

    String tbank="",bank_name="",apName="",apDate="",apTitle="",apContent="",apLaw="",apPs="",apHide="",apNo="",a="";
    ...
    if(act.equals("New")) { 
     ...
     // XML Ducument for 總機構代碼 end 
        ...
        if(bean != null) {                  	
            ...
            apName= bean.getValue("ap_name") != null ? String.valueOf(bean.getValue("ap_name")) : "";
            apDate= bean.getValue("ap_date") != null ? String.valueOf(bean.getValue("ap_date")) : "";
            apTitle= bean.getValue("ap_title") != null ? String.valueOf(bean.getValue("ap_title")) : "";
            apContent= bean.getValue("ap_content") != null ? String.valueOf(bean.getValue("ap_content")) : "";
            apLaw= bean.getValue("ap_laws") != null ? String.valueOf(bean.getValue("ap_laws")) : "";
            apPs= bean.getValue("ap_ps") != null ? String.valueOf(bean.getValue("ap_ps")) : "";
            apHide= bean.getValue("ap_hide") != null ? String.valueOf(bean.getValue("ap_hide")) : "";
            apNo= bean.getValue("ap_no") != null ? String.valueOf(bean.getValue("ap_no")) : "";
...
<script language="javascript" src="js/MC013W.js"></script>
...
function MoveSel(a,b) 
{
	if(a!="全部")
   {
		   b.value=a.substring(8);
   }  
}
//-->
</script>
<BODY bgColor=#FFFFFF>
<Form name='form' method=post action='MC013W.jsp'>
<input type='hidden' name="act" value=''>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           <td width="35%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
           <td width="30%"><font color='#000000' size=4><b><center>處分書</center></b></font> </td>
           <td width="35%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
         </tr>
</table>
...
<tr class="sbody">
    ...
    <input type='hidden' name="apDate" value="">
...
<tr class="sbody">
    <td width="118" bgcolor="#BDDE9C" height="1">受處分人</td>
    <td width="416" bgcolor="#EBF4E1" height="1">
  <input type='text' maxlength='30' name="apName" size="27" ><img border="0" src="../images/arrow_left.gif" width="24" height="22" onclick="MoveSel(document.form.tbank.options[document.form.tbank.selectedIndex].text,document.form.apName)">同受處分機構</td>  
</tr> 
...
<tr class="sbody">
    <td width="118" bgcolor="#BDDE9C" height="1">受處分人</td>
    <td width="416" bgcolor="#EBF4E1" height="1"><input type='text' maxlength='30' name="apName" size="27" value='<%=apName%>'></td> 
</tr>
<tr class="sbody">
    <td width="118" bgcolor="#BDDE9C" height="1">受處分日期</td>
    <td width="416" bgcolor="#EBF4E1" height="1"><%=apDate%></td>
    <input type='hidden' name='apDate' value='<%=apDate%>'>   
</tr>
<%}%>
<tr class="sbody">
<td width="118" bgcolor="#BDDE9C" height="1">主旨</td>
<td width="416" bgcolor="#EBF4E1" height="1">
<textarea rows="2" name="apTitle" cols="87" maxlength=500><%=apTitle%></textarea></td>
</tr>
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">事實及理由</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <textarea rows="5" cols="87" name='apContent' ><%=apContent%></textarea></td>
</tr> 
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">注意事項</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <textarea rows="3" cols="87" name='apPs' ><%=apPs%></textarea></td>
</tr>
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">法令依據</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <textarea rows="3" cols="87" name='apLaw' ><%=apLaw%></textarea></td>
</tr>
<tr class="sbody">
  <td width="173" bgcolor="#BDDE9C" height="20">是否將此筆資料給予檢查局 ?</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <input type='radio' name='apHide' value="0" <%if(apHide.equals("0")||act.equals("New")) out.print("checked");%>>是 
  <input type='radio' name='apHide' value="1" <%if(apHide.equals("1")) out.print("checked");%>>否
  </td>
</tr>
</Table>
                    <tr>
