...
//111.04.06 調整Edge無法挑選縣市別/金融機構代碼無資料可挑選 by 2295
//111.04.06 調整Edge可選擇項目,dbclick時無法將項目移至已選擇項目 by 2295
%>
...
<%
    ...
    String ds_memo2 = "(2)選取[各信用部]：按「應予評估資產明細資料」的報表內容列印";//108.04.26 add		   		   	   			
	...
	String E_MONTH = (session.getAttribute("E_MONTH")==null)?MONTH:(String)session.getAttribute("E_MONTH");                              
   	...
   	String printStyle = (session.getAttribute("printStyle")==null)?"xls":(String)session.getAttribute("printStyle");//108.04.25 add
   	//95.11.14 取得登入者資訊=================================================================================================
