...
<%
    ...
    sqlCmd = " select WTT03_1.sub_type,"
		   ...
		   + " and (WTT03_1.program_id like 'TC%' or WTT03_1.program_id like 'ZZ%' or WTT03_1.program_id like 'AS%')"
...
if( ( UpdateMuser_Data == null || !UpdateMuser_Data.equals("true")) && (dbData != null && dbData.size() != 0)){
   ...
   for(i=0;i<dbData.size();i++){   
       ...
       if(program_id.equals("AS001W") || program_id.equals("AS002W") || program_id.equals("ZZ001W")
       || program_id.equals("ZZ004W") || program_id.equals("ZZ005W") || program_id.equals("ZZ025W")          
       ){            
            if(!firstZZ){ 
               firstZZ=true;
			   out.println("foldersTree = gFld('<font size=2>管理系統</font>', ' ');");                       	               
   ...
   for(i=0;i<dbData.size();i++){   
       ...
       //====================================================================================       
       if(program_id.startsWith("ZZ") || program_id.startsWith("AS")){
          continue;
       }
       if(Program_Type.equals((String)((DataObject)dbData.get(i)).getValue("sub_type"))){                     				   
