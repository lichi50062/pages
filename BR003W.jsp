...
<%
	...
	if(firstStatus.equals("true")){//若從Menu點選時,先清空session裡的資料
	   ...
	   session.setAttribute("bn_type",null);   
...
<%!	
	private final static String report_no = "BR003W";
    ...
    private boolean CheckPermission(HttpServletRequest request){//檢核權限    	    
            ...
            Properties permission = ( session.getAttribute("BR003W")==null ) ? new Properties() : (Properties)session.getAttribute("BR003W");				                
            if(permission == null){
              System.out.println("BR003W.permission == null");
            }else{
               System.out.println("BR003W.permission.size ="+permission.size());
