<%
//95.10.16 add 業務經營分析報告UserProgram
%>
...
<%
    ...
    sqlCmd = " select  WTT03_1.program_id,WTT03_1.PROGRAM_NAME,WTT03_1.url_id,"
		   ...
		   + " and (WTT03_1.program_id like 'AN%')";		   
...
%>
<html><head>
<title>業務經營分析報告</title>
<link rel='stylesheet' href='js/ftie4style.css'>
<script src='js/ftiens4.js'></script>
<td>&nbsp;&nbsp;<font color='red' size='2px'><b>業務經營分析報告</b></font></td>
<script>
<%   
out.println("foldersTree = gFld('<font size=2>業務經營分析報告</font>', ' ');");//95.10.16當沒有權限時,預設顯示該資料夾                          
