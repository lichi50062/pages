...
function doSubmit(){
   ...
   this.document.forms[0].action = "/pages/FR005W_Excel.jsp";
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="60%"><font color='#000000' size=4><b><center>全體<%=title%>按縣市別平均利率</center></b></font></td>
    <td width="20%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
