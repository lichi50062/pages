...
<%!
    ...
    private final static String BankListPgName = "/pages/FR036W_Qry.jsp";          
    private final static String RptCreatePgName = "/pages/FR036W_Excel.jsp";        
    ...
    private boolean CheckPermission(HttpServletRequest request){//檢核權限    	    
            ...
            if(permission == null){
              System.out.println("FR036W.permission == null");
            }else{
               System.out.println("FR036W.permission.size ="+permission.size());
