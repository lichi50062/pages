...
<%
	...
	System.out.println("@@TC56_List.jsp Start...");
	System.out.println("TC56_List.sztbank_no="+sztbank_no);	
	
	List EXWARNIDFList = (List)request.getAttribute("EXWARNIDFList");		
	if(EXWARNIDFList == null){
	   System.out.println("EXWARNIDFList == null");
	}else{
	   System.out.println("EXWARNIDFList.size()="+EXWARNIDFList.size());
	}
	...
	if(permission == null){
       System.out.println("TC56_List.permission == null");
    }else{
       System.out.println("TC56_List.permission.size ="+permission.size());               
    }
%>
                ...
                <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr class="sbody">
						...
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='ITEM_ID' value="" size='4' maxlength='4' >
					  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="sbody">
						...
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='ITEM_NAME' value="" size='50' maxlength='100' ></td>
                    </tr>
                    </table>
                      	...
                      	<td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#76C657">                      
                      		...
                      		if(EXWARNIDFList != null){ %>
                      		 	<tr class="sbody" bgcolor="#BFDFAE">
                      		    	<td width="15">&nbsp;</td>           
                      		    	<td width="100">異常警訊項目</td>
                      		    	<td width="150">代碼名稱</td>
								</tr>   
                   		    <%
                   		    if(EXWARNIDFList.size() == 0){%>
                   			   	<tr class="sbody" bgcolor="<%=bgcolor%>">
                   			   		<td colspan=11 align=center>無資料可供查詢</td>
                   			   	<tr>
                   			<%}
                    			while(i < EXWARNIDFList.size()){ 
                    		      	bgcolor = (i % 2 == 0)?"#EBF4E1":"#FFFFCC";	                    		      
                      		%>                         	  
                          		<tr class="sbody" bgcolor="<%=bgcolor%>">
                            		<td width="15"><%=i+1%></td>           
            						<td width="100"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXWARNIDFList.get(i)).getValue("item_id")%>');">
            							<%if( ((DataObject)EXWARNIDFList.get(i)).getValue("item_id") != null ){
                    		    			out.print((String)((DataObject)EXWARNIDFList.get(i)).getValue("item_id")); 
                    		  			}%></td>
                    		  		<td width="150"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXWARNIDFList.get(i)).getValue("item_id")%>');">
                    					<%if( ((DataObject)EXWARNIDFList.get(i)).getValue("item_name") != null ){
                    						out.print((String)((DataObject)EXWARNIDFList.get(i)).getValue("item_name"));
                    					}%> </td>
   					      		</tr> 
					      <%
                  			   i++;
...
<%System.out.println("@@TC56_List.jsp End..");%>