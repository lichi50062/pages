...
//99.12.29 add 排序欄位套用共用include by 2295
%>
...
<%
	...
	//System.out.println("BR008W_RptOrder.szExcelAction="+szExcelAction);	
%>
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("BR008W_RptOrder.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	getbtnFieldList();
<%}%>
