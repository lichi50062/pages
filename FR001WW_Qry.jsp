<%
//create 農漁會信用部經營概況統計表 by 2295
//101.08.21 add 機構顯示中英文名稱 by 2295
...
function doSubmit(){   
   ...
   if(confirm("本項報表會報行10-15秒，是否確定執行？")){
      this.document.forms[0].action = "/pages/FR001WW_Excel.jsp";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">  
  <tr>
    ...
    <td width="60%"><font color='#000000' size=4><b><center><%=title%>信用部經營概況統計表</center></b></font></td>
    <td width="20%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
...
<tr class="sbody">
	...
	<input type="radio" name="showEng" value="true" <%if("true".equals(showEng)){out.print("checked"); }%> >顯示&nbsp;&nbsp; 
	<input type="radio" name="showEng" value="false" >不顯示</td>	
</tr>
