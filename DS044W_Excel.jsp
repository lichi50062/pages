<%
//100.08.03 create 權益證券風險─市場風險應計提資本彙總表(6-B) by 2295
...
<%
	...
	try{	      	
			...
			titleName += "權益證券風險─市場風險應計提資本彙總表(6-B)";	  		
			//年
			...
			main_table.append(" 		 ) ");	
			if(!sum_check){//100.07.28沒有選取到合計欄位(150000,160000)
                ...
                for(i=0;i<dbData.size();i++){            
                    ...
                    for(int cellIdx =2;cellIdx < (new Short(lastCellNum)).intValue();cellIdx++){                    
                         ...
                         if("001000".equals(cell.getStringCellValue())){    
                            amt_unit = parseAgriBankRpt.getCountry(amt,"1");//取得國別名稱                            
                         }else{
                            amt_unit = "";
                         }
