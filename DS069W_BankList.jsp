...
<%
	...
	System.out.println("DS069W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("DS069W_BankList.hsien_id="+hsien_id);
    ...
    //取得DS069W的權限
	Properties permission = ( session.getAttribute("DS069W")==null ) ? new Properties() : (Properties)session.getAttribute("DS069W"); 
	if(permission == null){
       System.out.println("DS069W_BankList.permission == null");
    }else{
       System.out.println("DS069W_BankList.permission.size ="+permission.size());               
    }	
	...
	<table width="750" border="0" align="center" cellpadding="1" cellspacing="1">        
        <tr> 
          <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="160"><img src="images/banner_bg1.gif" width="160" height="17"></td>
                <td width="*" class="title_font">A15電子銀行及網路銀行交易情形資料表</td>
                <td width="160"><img src="images/banner_bg1.gif" width="160" height="17"></td>
              </tr>
            </table></td>
        </tr>
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                          ...
                          <td><img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">查詢年月 :</span> 						  						
                             <input type='text' name='S_YEAR' value="<%=S_YEAR%>" size='3' maxlength='3' 
        						...
        						<%}%>
        						 ...
        						 <input type='text' name='E_YEAR' value="<%=E_YEAR%>" size='3' maxlength='3' 
									onblur='CheckYear(this)'
									onchange="javascript:changeCity(document.BankListfrm.HSIEN_ID, document.BankListfrm.S_YEAR, document.BankListfrm);">
								<font color='#000000'>年                            
                    ...
                    <tr> 
                 	  <td class="body_bgcolor">
                        ...
                        <tr>                           
                          <td width="750" align=left><font color="red" size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;選取[各信用部]：按「電子銀行及網路銀行交易情形資料表」的報表內容列印</font></td>                              
                        </tr>                                                  
                        </table>
                      </td>
                    </tr>
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("DS069W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
