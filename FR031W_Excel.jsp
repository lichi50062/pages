...
<%@ page import="com.tradevan.util.report.RptFR031W" %>
...
<%
	try{	
	    System.out.println("createRpt="+RptFR031W.createRpt(s_year,s_month,e_year,e_month,""));
	    String filename = "農業信用保證基金業務統計(一).xls";//108.05.28 add
