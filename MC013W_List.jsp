...
<%
	...
	System.out.println("Page: MC013W_List.jsp    Action:"+act);
    ...
    String apName = Utility.getTrimString(dataMap.get("apName")) ;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           ...
           <td width="30%"><font color='#000000' size=4><b><center>處分書查詢</center></b></font> </td>
...
<td width="416" bgcolor="#EBF4E1" height="1">
  ...
  <a href="/pages/MC013W.jsp?act=New" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image102','','images/bt_addb.gif',1)">
...
<tr class="sbody">
    ...
    <td width="416" bgcolor="#EBF4E1" height="1">
    <input type="text" name="apName" size="50"></tr>    
...
<Table border="1" width="100%"  bgcolor="#FFFFF" bordercolor="#76C657">
      <tr class="sbody" bgcolor="#BFDFAE">
        ...
        <td width="25%" height="14">任職行號</td>          
        <td width="25%" height="14">受處分人</td>
        <td width="40%" height="14">主旨</td> 
      </tr>
      ...
      <tr class="sbody" bgcolor='<%=(i % 2 == 0)?"#EBF4E1":"#FFFFCC"%>'>
        <td width="10%" height="1"><a href=MC013W.jsp?act=Edit&bank_no=<%=bean.getValue("bank_no")%>&apNo=<%=bean.getValue("ap_no")%>><%=bean.getValue("ap_date")%></a>&nbsp;</td>
        ...
        <td width="25%" height="1"><%=bean.getValue("ap_name") != null ? bean.getValue("ap_name") : "&nbsp;"%></td>
        <td width="40%" height="1"><%=bean.getValue("ap_title") != null ? bean.getValue("ap_title") : "&nbsp;"%></td>  
      </tr>
      <%        }
     }else {%>            
    ...
    <td width="97%"> 
      <ul>                                                
        ...
        <% } else if(act.equals("Qry")) {%>
            <li>本網頁提供處分書查詢功能。</li>
            <li>按<font color="#666666">【查詢】</font>則依查詢條件值查詢資料。</li> 
		    <li>按<font color="#666666">【受處分日期】連結</font>則可查看此筆資料。</li>
