<%
// 99.10.28 create 資產證券化加權風險性資產計算總表(4-A-1) by 2295
//101.09.18 fix 增修部份欄位 by 2295
...
<%
	...
	try{	      	
			...
			titleName += "資產證券化加權風險性資產計算總表(4-A-1)";	  		
			//年
            ...
            */                                   
			...
			//99.10.28 合併acc_code時,科目代號跟欄位名稱時,合併後的列會縮小
            for(i=0;i<btnFieldList_data.size();i++){
                ...
                if(((String)((List)btnFieldList_data.get(i)).get(0)).equals("110000") ||
                   ...
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("170000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("180000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("190000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("114000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("124000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("134000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("144000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("154000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("164000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("174000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("184000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("194000") ){
