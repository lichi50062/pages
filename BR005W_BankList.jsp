...
// 99.12.24 fix 根據查詢年度.100年以後取得新縣市別.100年以前取得舊縣市別 by 2295
...
<%
	...
	//System.out.println("BR005W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("BR005W_BankList.hsien_id="+hsien_id);
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("BR005W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
