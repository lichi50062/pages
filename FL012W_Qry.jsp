...
function doSubmit(){   
	this.document.forms[0].action = "/pages/FL012W_Excel.jsp?act=download";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="60%"><font color='#000000' size=4><b><center>政策性農業專案貸款未結缺失案件明細表</center></b></font></td>
    <td width="20%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
...
<tr class="sbody">
	...
	<td bgcolor="#EBF4E1" height="1">
	  <input type='radio' name='ex_Type' value='FEB'  >金管會檢查報告&nbsp;
	  <input type='radio' name='ex_Type' value='AGRI' >農業金庫查核&nbsp;
	  <input type='radio' name='ex_Type' value='BOAF' >農金局訪查&nbsp;
	  <input type='radio' name='ex_Type' value='ALL' checked>全部&nbsp;      
  	</td>
</tr>
