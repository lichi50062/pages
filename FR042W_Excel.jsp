...
<%@ page import="com.tradevan.util.report.FR042W_Excel" %>
...
<%
	try{	
	    String actMsg = FR042W_Excel.createRpt(S_YEAR,S_MONTH,Unit);
	    System.out.println("createRpt="+actMsg);
	    String filename ="農業發展基金及農業天然災害基金貸款執行情形表.xls";//108.05.28 add
