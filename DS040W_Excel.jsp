<%
//100.07.05 create 利率風險-個別風險之資本計提計算表(新台幣)(6-A1) by 2295
//101.10.04 fix 增修部份欄位 by 2295
...
<%
	...
	try{	      	
			...
			titleName += "利率風險-個別風險之資本計提計算表(新台幣)(6-A1)";	  		
			//年
        ...
        for(i=0;i<btnFieldList_data.size();i++){
            ...
            for(i=0;i<btnFieldList_data.size();i++){
				...
				//合計部份				
                if(((String)((List)btnFieldList_data.get(i)).get(0)).equals("112000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("122000")){
