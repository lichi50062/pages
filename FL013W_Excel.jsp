...
<%@ page import="com.tradevan.util.report.RptFL013W" %>
   ...
   String filename="RptFL013W.xls";
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		...
    		try{
	 			System.out.println("=========call RptFL013W") ;
    			actMsg =RptFL013W.createRpt();
...
<%!
    private final static String report_no = "FL013W";
