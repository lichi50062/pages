...
<%
	...
	System.out.println("@@TC53_List.jsp Start...");
	System.out.println("TC53_List.sztbank_no="+sztbank_no);	
	
	List EXBASISNOFList = (List)request.getAttribute("EXBASISNOFList");		
	if(EXBASISNOFList == null){
	   System.out.println("EXBASISNOFList == null");
	}else{
	   System.out.println("EXBASISNOFList.size()="+EXBASISNOFList.size());
	}
	...
	//取得TC53的權限
	Properties permission = ( session.getAttribute("TC53")==null ) ? new Properties() : (Properties)session.getAttribute("TC53"); 
	if(permission == null){
       System.out.println("TC53_List.permission == null");
    }else{
       System.out.println("TC53_List.permission.size ="+permission.size());               
    }
%>
<script language="javascript" src="js/Common.js"></script>
<script language="javascript" src="js/TC53.js"></script>
<script language="javascript" event="onresize" for="window"></script>
<html>
<head>
<title> 檢查依據代號維護 </title>
		  ...
		  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr class="sbody">
						<td width='15%' align='left' bgcolor='#BDDE9C'>檢查依據代碼</td>						  
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='BASIS_ID' value="" size='4' maxlength='4' >
					  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="sbody">
						...
						<td width='85%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='BASIS_NAME' value="" size='50' maxlength='100' ></td>
                    </tr>
                    </table>
                      	...
                      	<td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#76C657">                      
                      		...
                      		if(EXBASISNOFList != null){ %>
                      		 	<tr class="sbody" bgcolor="#BFDFAE">
                      		    	<td width="15">&nbsp;</td>           
                      		    	<td width="100">檢查依據代碼</td>
                      		    	<td width="150">代碼名稱</td>
								</tr>   
                   		    <%
                   		    if(EXBASISNOFList.size() == 0){%>
                   			   	<tr class="sbody" bgcolor="<%=bgcolor%>">
                   			   		<td colspan=11 align=center>無資料可供查詢</td>
                   			   	<tr>
                   			<%}
                    			while(i < EXBASISNOFList.size()){ 
                    		      	bgcolor = (i % 2 == 0)?"#EBF4E1":"#FFFFCC";	                    		      
                      		%>                         	  
                          		<tr class="sbody" bgcolor="<%=bgcolor%>">
                            		<td width="15"><%=i+1%></td>           
            						<td width="100"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXBASISNOFList.get(i)).getValue("basis_id")%>');">
            							<%if( ((DataObject)EXBASISNOFList.get(i)).getValue("basis_id") != null ){
                    		    			out.print((String)((DataObject)EXBASISNOFList.get(i)).getValue("basis_id")); 
                    		  			}%></td>
                    		  		<td width="150"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXBASISNOFList.get(i)).getValue("basis_id")%>');">
                    					<%if( ((DataObject)EXBASISNOFList.get(i)).getValue("basis_name") != null ){
                    						out.print((String)((DataObject)EXBASISNOFList.get(i)).getValue("basis_name"));
                    					}%> </td>
   					      		</tr> 
					      <%
                  			   i++;
...
<%System.out.println("@@TC53_List.jsp End..");%>