...
<%@ page import="com.tradevan.util.report.FR043W_Excel" %>
...
<%
	try{	
 	    String actMsg = FR043W_Excel.createRpt(S_YEAR,S_MONTH,Unit);
	    System.out.println("createRpt="+actMsg);
	    String filename = "農業發展基金及農業天然災害救助基金貸放餘額統計.xls";//108.05.28 add
