<%
//100.07.13 create 交易對手信用風險加權風險性資產額計算表(2-E) by 2295 
//108.11.26 add 報表格式轉換 by 2295
%>
...
<%
   ...
   String printStyle = "";//輸出格式 108.11.26 add
   //輸出格式 108.11.26 add
   ...
   if(act.equals("view")){
      ...
      response.setHeader("Content-disposition","inline; filename=view."+printStyle);//108.11.26調整顯示的副檔名
   }else if (act.equals("download")){   
      response.setHeader("Content-Disposition","attachment; filename=download."+printStyle);//108.11.26調整顯示的副檔名
   }   
%>
<%
	...
	try{	      	
			...
			titleName += "交易對手信用風險加權風險性資產額計算表(2-E)";	  		
			//年
            ...
            */                                   
            ...
            String filename = titleName+".xls";//108.11.26 add
            if(!printStyle.equalsIgnoreCase("xls")) {//108.11.26非xls檔須執行轉換	                
            ...
            FileInputStream fin = new FileInputStream(Utility.getProperties("reportDir")+System.getProperty("file.separator")+ filename);//108.11.26 fix 	 
