...
//99.12.23 add 報表欄位.可挑選項目套用共用include by 2295
%>
...
<%
	...
	System.out.println("BR004W_RptColumn.szExcelAction="+szExcelAction);
...
<!--script language="javascript" src="js/BR004W.js"></script-->
...
function ResetAllData(){
    if(confirm("確定要清除已選定的資料嗎？")){  	
        ...
        this.document.forms[0].ABDICATE_CODE[0].selected=true;   
          ...
          <td><table width="750" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#5DA525">
              <tr> 
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr> 
                      <td bgcolor="#CDE6BF"> <table width="500" border="0" align="center" cellpadding="1" cellspacing="1" class="sbody">
                          <tr class="sbody"> 
                    ...
                    <tr> 
                      <td bgcolor="#E9F4E3"> <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr class="sbody">
                          <%
                          List position_code_data = DBManager.QueryDB_SQLParam("select * from cdshareno where cmuse_div='005'",null,""); 
                          %>
                          ...
                          <tr class="sbody"> 
                            <td><img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">卸任與否 :</span>                                
                               <select name="ABDICATE_CODE">                               
                                ...
                                <option value="N" <%if(abdicate_code.equals("N")) out.print("selected");%>>未卸任</option>                                                             
                              </select>
                            </td>
                          </tr>
                        </table></td>
