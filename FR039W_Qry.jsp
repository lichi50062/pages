...
<%
	...
	if(permission == null){
       System.out.println("FR039W_Qry.permission == null");
    }else{
       System.out.println("FR039W_Qry.permission.size ="+permission.size());               
    }
%>
...
function doSubmit(){   
   ...
   {
   this.document.forms[0].action = "/pages/FR039W_Excel.jsp";	
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600">農漁會信用部存/放款餘額表</font>
                  </center>
                  </font> </td>
                <td width="180"><img src="images/banner_bg1.gif" width="180" height="17"></td>
              </tr>
