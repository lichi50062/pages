<%
//100.07.19 create 表外項目信用約當金額－標準法（非創始銀行）(4-D-1) by 2295     
//101.10.11 fix 增修部份欄位 by 2295
...
<%
	...
	try{	      	
			...
			titleName += "表外項目信用約當金額－標準法（非創始銀行）(4-D-1)";	  		
			//年
            ...
            */                                   
            ...
            for(i=0;i<btnFieldList_data.size();i++){
                ...
                if(((String)((List)btnFieldList_data.get(i)).get(0)).equals("110000") ||  
                   ...
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("112100") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("113110") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("122100") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("123110")){
