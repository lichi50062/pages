...
<%
  ...
  if(permission == null){
    System.out.println("FR057W_Qry.permission == null");
  }else{
    System.out.println("FR057W_Qry.permission.size =" + permission.size());               
  }
%>
...
function doSubmit(){ 
  if (confirm("本項報表會報行10-15秒，是否確定執行？")) {
    this.document.forms[0].action = "/pages/FR057W_Excel.jsp";	
      ...
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="*"><font color='#000000' size=4> 
            <center><font color="#336600">全體農漁會信用部從業人員參加金融相關業務進修情形統計表</font></center></font>
          </td>
          <td width="50"><img src="images/banner_bg1.gif" width="50" height="17"></td>
        </tr>
      </table>
