...
<%
	...
	System.out.println("FR0066WA_RptStyle.szExcelAction="+szExcelAction);
	...
	if(permission == null){
       System.out.println("FR0066WA_RptStyle.permission == null");
    }else{
       System.out.println("FR0066WA_RptStyle.permission.size ="+permission.size());               
    }	
%>
          ...
          <td><table width="780" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#5DA525">
              <tr> 
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr> 
                      <td bgcolor="#CDE6BF"> <table width="780" border="0" align="center" cellpadding="1" cellspacing="1" class="sbody">
                          <tr class="sbody"> 
                    ...
                    <tr> 
                      <td bgcolor="#E9F4E3" span class="mtext">已儲存之報表查詢條件範本名稱:<select size="1" name="D1">
                          <option>查詢條件範本1</option>
                          <option>查詢條件範本2</option>
                        </select>&nbsp;&nbsp; <a href="javascript:fn_ShowPanel('ReadRpt')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','images/bt_readreportb.gif',1)"><img src="images/bt_readreport.gif" name="Image10" width="86" height="25" border="0"></a></td> 
                    </tr>                    
                    
                    <tr> 
                      <td bgcolor="#E9F4E3" span class="mtext">欲儲存之報表查詢條件範本名稱:<input type="text" name="T1" size="40">
                         &nbsp;&nbsp;
                        <a href="javascript:fn_ShowPanel('SaveRpt')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','images/bt_savereportb.gif',1)"><img src="images/bt_savereport.gif" name="Image9" width="86" height="25" border="0"></a></td>
                    </tr>        
