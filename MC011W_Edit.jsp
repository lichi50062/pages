...
<%
    ...
    Properties permission = ( session.getAttribute("MC011W")==null ) ? new Properties() : (Properties)session.getAttribute("MC011W");
    if(permission == null){
       System.out.println("MC011W_Edit.permission == null");
    }else{
       System.out.println("MC011W_Edit.permission.size ="+permission.size());
    }			
    System.out.println("Page: MC011W_Edit.jsp    Action:"+act);

    String tbank="",bank_name="",dffeDate="",dffeTitle="",dffeContent="",dffeType="",dffeBType="",dffeHide="",dffeNo="",a="";
    ...
    String dffeNum = Utility.getTrimString(request.getParameter("dffeNum" ));  
    
    if(act.equals("New"))
    {
    	dffeBType="20";
    }
    System.out.println("dffeBType="+dffeBType);
    ...
    if(act.equals("New")) { 
     ...
     // XML Ducument for 總機構代碼 end 
        ...
        if(bean != null) {            
            ...
            dffeDate= bean.getValue("dffe_date") != null ? String.valueOf(bean.getValue("dffe_date")) : "";
            dffeNum= bean.getValue("dffe_number") != null ? String.valueOf(bean.getValue("dffe_number")) : "";
            dffeTitle= bean.getValue("dffe_title") != null ? String.valueOf(bean.getValue("dffe_title")) : "";
            dffeContent= bean.getValue("dffe_content") != null ? String.valueOf(bean.getValue("dffe_content")) : "";
            dffeType= bean.getValue("dffe_type") != null ? String.valueOf(bean.getValue("dffe_type")) : "";
            dffeBType= bean.getValue("dffe_b_type") != null ? String.valueOf(bean.getValue("dffe_b_type")) : "";
            dffeHide= bean.getValue("dffe_hide") != null ? String.valueOf(bean.getValue("dffe_hide")) : "";
            dffeNo= bean.getValue("dffe_no") != null ? String.valueOf(bean.getValue("dffe_no")) : "";
            
            //System.out.println("params:"+"tbank:"+tbank+" bank_name:"+bank_name+" loalAddDate:"+loalAddDate+" loalMgr:"+loalMgr+
            		           //" loalNum:"+loalNum+" loalContent:"+loalContent+" loalState:"+loalState+" loalPs:"+loalPs+
            		           //" loal_Hide:"+loalHide+" loalNo:"+loalNo);
        }
    }
%>
...
<HTML>
<HEAD>
<TITLE>個別農漁會解釋函令</TITLE>
<script language="javascript" src="js/Common.js"></script>
<script language="javascript" src="js/MC011W.js"></script>
...
<BODY bgColor=#FFFFFF>
<Form name='form' method=post action='MC011W.jsp'>
<input type='hidden' name="act" value=''>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           <td width="35%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
           <td width="30%"><font color='#000000' size=4><b><center>個別農漁會解釋函令</center></b></font> </td>
           <td width="35%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
         </tr>
</table>
...
<tr class="sbody">
<td width="118" bgcolor="#BDDE9C" height="1">發文對象</td>
<td width="416" bgcolor="#EBF4E1" height="1">           
...
<tr class="sbody">
    ...
    <td width="416" bgcolor="#EBF4E1" height="1">
    <input type='hidden' name="dffeDate" value="">
...
<tr class="sbody">
<td width="118" bgcolor="#BDDE9C" height="1">發文字號</td>
<td width="416" bgcolor="#EBF4E1" height="1">
  <input type='text' maxlength='50' name="dffeNum" size="44" ></td>
</tr>
<%}%>    
<%if(act.equals("Edit")){%>
<tr class="sbody">
...
<input type='hidden' name='dffeNo' value='<%=dffeNo%>'>
</tr>
<tr class="sbody">
    <td width="118" bgcolor="#BDDE9C" height="1">發文日期</td>
    <td width="416" bgcolor="#EBF4E1" height="1"><%=dffeDate%></td>   
    <input type='hidden' name='dffeDate' value='<%=dffeDate%>'>
</tr> 
<tr class="sbody">
    <td width="118" bgcolor="#BDDE9C" height="1">發文字號</td>
    <td width="416" bgcolor="#EBF4E1" height="1"><%=dffeNum%></td>   
    <input type='hidden' name='dffeNum' value='<%=dffeNum%>'>
</tr>
<%}%>
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">函令主旨</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <input type='text' maxlength='30' name='dffeTitle' size="87" value='<%=dffeTitle%>' maxlength='400'></td>
</tr>
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">內容</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <textarea rows="6" cols="87" name='dffeContent'maxlength='3000'><%=dffeContent%></textarea> 
  </td>
</tr>
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">業務類別</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <select size="1" name="dffeType" >
<%   List dtypeList = (List) request.getAttribute("DType");
     if(dtypeList != null) {
         for(int i=0; i < dtypeList.size(); i++) {
             DataObject bean =(DataObject)dtypeList.get(i);

               a=String.valueOf(bean.getValue("select_num"));
       
%>   
     <option value="<%=bean.getValue("select_num")%>" <%if (dffeType.equals(a)) out.print("selected");%>><%=bean.getValue("select_name")%></option>
<%       }
     }
%>
  </select></td>
...
<tr class="sbody">
  <td width="118" bgcolor="#BDDE9C" height="20">機構類別</td>
  <td width="416" bgcolor="#EBF4E1" height="20">
  <select size="1" name="dffeBType" >
<%   List dbtypeList = (List) request.getAttribute("DBType");
     if(dbtypeList != null) {
         for(int i=0; i < dbtypeList.size(); i++) {
             DataObject bean =(DataObject)dbtypeList.get(i);             

                a=String.valueOf(bean.getValue("select_num"));
             
%>   
     <option value="<%=bean.getValue("select_num")%>" <%if (dffeBType.equals(a)) out.print("selected");%>><%=bean.getValue("select_name")%></option>
<%       }
     }
%>
  </select> 
...
<tr class="sbody">
  ...
  <td width="416" bgcolor="#EBF4E1" height="20">
  <input type='radio' name='dffeHide' value="0" <%if(dffeHide.equals("0")||act.equals("New")) out.print("checked");%>>是 
  <input type='radio' name='dffeHide' value="1" <%if(dffeHide.equals("1")) out.print("checked");%>>否
  </td>
</tr>
...
setSelect(form.dffeBType,"<%=dffeBType%>");
-->
</script>
<%}%>
</HTML>
