...
<%
	...
	System.out.println("@@TC55_List.jsp Start...");
	System.out.println("TC55_List.sztbank_no="+sztbank_no);	
	
	List EXACTNOFList = (List)request.getAttribute("EXACTNOFList");		
	if(EXACTNOFList == null){
	   System.out.println("EXACTNOFList == null");
	}else{
	   System.out.println("EXACTNOFList.size()="+EXACTNOFList.size());
	}
	...
	if(permission == null){
       System.out.println("TC55_List.permission == null");
    }else{
       System.out.println("TC55_List.permission.size ="+permission.size());               
    }
%>
<script language="javascript" src="js/Common.js"></script>
<script language="javascript" src="js/TC55.js"></script>
		  ...
		  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr class="sbody">
						<td width='20%' align='left' bgcolor='#BDDE9C'>處理意見代碼</td>						  
						<td width='80%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='ACT_ID' value="" size='4' maxlength='4' >
					  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="sbody">
						...
						<td width='80%' colspan=2 bgcolor='EBF4E1'>
					  		<input type='text' name='ACT_NAME' value="" size='50' maxlength='100' ></td>
                    </tr>
                    </table>
                      	...
                      	<td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#76C657">                      
                      		...
                      		if(EXACTNOFList != null){ %>
                      		 	<tr class="sbody" bgcolor="#BFDFAE">
                      		    	<td width="10%">&nbsp;</td>           
                      		    	<td width="15%">處理意見代碼</td>
                      		    	<td width="75%">代碼名稱</td>
								</tr>   
                   		    <%
                   		    if(EXACTNOFList.size() == 0){%>
                   			   	<tr class="sbody" bgcolor="<%=bgcolor%>">
                   			   		<td colspan=11 align=center>無資料可供查詢</td>
                   			   	<tr>
                   			<%}
                    			while(i < EXACTNOFList.size()){ 
                    		      	bgcolor = (i % 2 == 0)?"#EBF4E1":"#FFFFCC";	                    		      
                      		%>                         	  
                          		<tr class="sbody" bgcolor="<%=bgcolor%>">
                            		<td width="10%"><%=i+1%></td>           
            						<td width="15%"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXACTNOFList.get(i)).getValue("act_id")%>');">
            							<%if( ((DataObject)EXACTNOFList.get(i)).getValue("act_id") != null ){
                    		    			out.print((String)((DataObject)EXACTNOFList.get(i)).getValue("act_id")); 
                    		  			}%></td>
                    		  		<td width="75%"><a href="javascript:doSubmit(this.document.forms[0],'Edit','<%=(String)((DataObject)EXACTNOFList.get(i)).getValue("act_id")%>');">
                    					<%if( ((DataObject)EXACTNOFList.get(i)).getValue("act_name") != null ){
                    						out.print((String)((DataObject)EXACTNOFList.get(i)).getValue("act_name"));
                    					}%> </td>
   					      		</tr> 
					      <%
                  			   i++;
...
<%System.out.println("@@TC55_List.jsp End..");%>