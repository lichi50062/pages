...
<%
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp//95.11.03 fix 使用Utility.CheckPermission檢核權限 by 2295
        ...
        if(act.equals("RptColumn")){//報表欄位   
			List FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"BR010W.TXT");	
        	//List FieldList = Utility.getFileData("D:\\WorkSpace\\pboaf1\\MIS\\schemaDir"+System.getProperty("file.separator")+"BR010W.TXT");						
       	 	System.out.println("FieldListRoot ===> "+Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"BR010W.TXT");
...
<%!
    private final static String report_no = "BR010W";
