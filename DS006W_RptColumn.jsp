...
function doSubmit(cnd){      
   if(cnd == 'createRpt'){
      ...
      if(!chInput(document.RptColumnfrm,'')) return;//95.12.05 add 起始日期不可大於結束日期
      //漁會科目代號新舊無法同時列印    
      if(document.RptColumnfrm.DS_bank_type.value == '7'){
        if(parseInt(document.RptColumnfrm.S_YEAR.value)<=102 && parseInt(document.RptColumnfrm.E_YEAR.value)>=103){
