...
function doSubmit(){   
	this.document.forms[0].action = "/pages/FL013W_Excel.jsp?act=download";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="70%"><font color='#000000' size=4><b><center>政策性農業專案貸款尚未繳還補貼息明細表</center></b></font></td>
    <td width="15%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
