...
<%!
    ...
    private final static String BankListPgName = "/pages/FR036WA_Qry.jsp";          
    private final static String RptCreatePgName = "/pages/FR036WA_Excel.jsp";        
    ...
    private boolean CheckPermission(HttpServletRequest request){//檢核權限    	    
            ...
            if(permission == null){
              System.out.println("FR036WA.permission == null");
            }else{
               System.out.println("FR036WA.permission.size ="+permission.size());
