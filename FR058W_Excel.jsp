...
<%
   ...
   String filename="全體農漁會信用部主任及分部主任參訓情形統計表.xls";
  
   System.out.println("FR058W_Excel.S_YEAR="+S_YEAR);
   System.out.println("FR058W_Excel.act="+act);
   ...
   if(session.getAttribute("muser_id") == null){//session timeout
      System.out.println("FR058W login timeout");
   ...
   if(doProcess){//若muser_id資料時,表示登入成功====================================================================
   		if(!Utility.CheckPermission(request,"FR058W")){//無權限時,導向到LoginError.jsp
	    	...
	    	if(act.equals("Qry")){
   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
	    			actMsg =RptFR058W.createRpt(S_YEAR,S_MONTH);
...
<%!
    ...
    private final static String QryPgName = "/pages/FR058W_Qry.jsp";
    private final static String RptCreatePgName = "/pages/FR058W_Excel.jsp";
