...
<%
    ...
    String ds_memo1 = "(1)選取[各信用部]：按「信用部從業人員參加金融相關業務進修情形明細資料」的報表內容列印";//108.04.26 add	
	String ds_memo2 = "";//108.04.26 add	
        ...
        <tr> 
          <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*" class="title_font">信用部從業人員參加金融相關業務進修情形明細資料</td>
                <td width="130"><img src="images/banner_bg1.gif" width="130" height="17"></td>
              </tr>
            </table></td>
        </tr>
