<%
//94.12.04 存放款統計表(FR040WW)--總表 by 4180
//99.09.17 add 套用saveSearchParameter取得參數 by 2295
...
<%@ page import="com.tradevan.util.report.RptFR040WW" %>
   	...
   	if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp   
		...
		if(act.equals("Qry")){
   		...
   		if(act.equals("view") || act.equals("download")){
   			try{
				actMsg =RptFR040WW.createRpt(S_YEAR,S_MONTH,Unit,bank_type,rptStyle);
