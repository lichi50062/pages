...
<%
	Calendar rightNow = Calendar.getInstance();
 	...
 	String title=(bank_type.equals("6"))?"全體農會按縣市別經營指標變化表":"全體漁會按縣市別經營指標變化表";
 	//取得FR002W的權限
	Properties permission = ( session.getAttribute("FR002W")==null ) ? new Properties() : (Properties)session.getAttribute("FR002W"); 
	if(permission == null){
       System.out.println("FR002W_Qry.permission == null");
    }else{
       System.out.println("FR002W_Qry.permission.size ="+permission.size());               
    }
%>
...
function doSubmit(){   
   ...
   this.document.forms[0].action = "/pages/FR002W_Excel.jsp";	
