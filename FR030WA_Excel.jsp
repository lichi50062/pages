<%
//94/01/03 by 4180 台灣區農會信用部支票存款戶數與餘額明細表
//99.04.12 fix 修改部分程式為公用 by 2808
...
<%@ page import="com.tradevan.util.report.FR030WA_Excel" %>
...
<%
	System.out.println("FR030WA_Excel statring");
   ...
   String filename=(bank_type.equals("6"))?"台灣區農會信用部支票存款戶數與餘額明細表.xls":"台灣區農會信用部支票存款戶數與餘額明細表.xls";
   String BankList="";
   ...
   //set next jsp 	
 	...
 	if(act.equals("view") || act.equals("download")){
 		try{		    
   			actMsg = FR030WA_Excel.createRpt(S_YEAR,S_MONTH,unit,bank_type,BankList_data);	    
        ...
        System.out.println("FR030WA_Excel Ending");
%>
<%@include file="./include/Tail.include" %>
<%!
    private final static String report_no = "FR030WA" ;
