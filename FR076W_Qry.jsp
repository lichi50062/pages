...
function doSubmit(){ 
  if (confirm("本項報表會報行10-15秒，是否確定執行？")) {
    this.document.forms[0].action = "/pages/FR076W_Excel.jsp";	
  ...
  <body leftmargin="0" topmargin="0">
    <form method=post action='#'>
		...
		<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
	        ...
	        <tr>
				<td width="20%"><img src="images/banner_bg1.gif"  width="200"  height="17"></td>
	    		<td width="60%"><font color='#000000' size=4><b><center>經營月報表</center></b></font></td>
	    		<td width="20%"><img src="images/banner_bg1.gif"  width="200"  height="17"></td>
	        </tr>
		</table>
