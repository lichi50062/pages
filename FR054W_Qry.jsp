...
function doSubmit(){ 
   ...
   */	 
   ...
   {
   this.document.forms[0].action = "/pages/FR054W_Excel.jsp";	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="70%"><font color='#000000' size=4><b><center>全體農漁會信用部各會員別放款金額一覽表</center></b></font></td>
    <td width="15%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
