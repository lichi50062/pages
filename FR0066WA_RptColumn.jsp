...
<%
	...
	System.out.println("FR0066WA_RptColumn.szExcelAction="+szExcelAction);
	//取得FR0066WA的權限
	Properties permission = ( session.getAttribute("FR0066WA")==null ) ? new Properties() : (Properties)session.getAttribute("FR0066WA"); 
	if(permission == null){
       System.out.println("FR0066WA_RptColumn.permission == null");
    }else{
       System.out.println("FR0066WA_RptColumn.permission.size ="+permission.size());               
    }	
%>
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr> 
                      <td bgcolor="#E9F4E3"> <table width="779" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#E9F4E3">
                          <tr> 
                            <td width="195">  
                            <select multiple  size=10  name="FieldListSrc" ondblclick="javascript:movesel(this.document.forms[0].FieldListSrc,this.document.forms[0].FieldListDst);" style="width: 300 ; font-size: 8pt">							
							</select>
                            </td>
                            ...
                            <td width="189"> 
                           <select multiple size=10  name="FieldListDst" ondblclick="javascript:movesel(this.document.forms[0].FieldListDst,this.document.forms[0].FieldListSrc);" style="width: 300;font-size: 8pt">							
							</select>
                           
                            </td>
                            <td width="130"><table width="116" border="0" align="center" cellpadding="3" cellspacing="3">
                                <tr>                                   
                                  <td width="24"><div align="center"><a href="javascript:moveup(this.document.forms[0].FieldListDst);"><img src="images/arrow_up.gif" width="24" height="22" border="0"></a></div></td>                        				        
                                  <td width="71" class="sbody">欄位上移</td>
                                </tr>
                                <tr> 
                                  <td width="24"><div align="center"><a href="javascript:movedown(this.document.forms[0].FieldListDst);"><img src="images/arrow_down.gif" width="24" height="22" border="0"></a></div></td>                        				        
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("FR0066WA_RptColumn.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	var bnlist;
