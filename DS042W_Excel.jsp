<%
//100.08.01 create 利率風險-一般市場風險之資本計提計算表(到期法)(新台幣)(6-A2-a) by 2295
...
<%
	...
	try{	      	
			...
			titleName += "利率風險-一般市場風險之資本計提計算表(到期法)(新台幣)";
			//年
            ...
            */                                   
            ...
            for(i=0;i<btnFieldList_data.size();i++){
                ...
                if(((String)((List)btnFieldList_data.get(i)).get(0)).equals("110000") ||
                   ...
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("901000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("902000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("903000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("904000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("905000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("906000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("907000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("908000") ||
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("909000") ||                   
                   ((String)((List)btnFieldList_data.get(i)).get(0)).equals("910000")){
