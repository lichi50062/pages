...
<%	
	...
	System.out.println("Page: TC21_list.jsp    Action:"+act);
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr> 
           ...
           <td width="50%"><font color='#000000' size=4><b><center>檢查報告編號查詢 </center></b></font> </td>
           <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
         </tr>
</table>
...
<td width="416" bgcolor="#EBF4E1" height="4">
  ...
  <br><font color="#FF0000">如果是局內產生, 請先鍵入派差通知單編號, 再按新增</font>
  </td> 
</tr>
<!-- 檢查報告編號 -->
...
<td width="100%"  height="63" colspan="2" valign='top'>
    <table border="1" width="100%" bgcolor="#FFFFF" bordercolor="#76C657" >
      ...
      <tr class="sbody" bgcolor='<%=(i % 2 == 0)?"#EBF4E1":"#FFFFCC"%>' >
        <td width="20%"  align='center'>&nbsp;<a href="javascript:doSubmit(form,'Edit','<%=bean.getValue("reportno")%>')"><%=bean.getValue("reportno")%></td>
        <td width="20%"  align='center'>&nbsp;<%=bean.getValue("disp_id") != null ? bean.getValue("disp_id") : ""%></td>
    ...
    <td width="97%"> 
      <ul>                                                
        ...
        <% } else if(act.equals("Qry")) {%>
            ...
            <li>按<font color="#666666">【查詢】</font>則依查詢條件值查詢資料。</li> 
		    <li>按<font color="#666666">【新增】</font>則新增一筆資料。</li> 
		    <li>按<font color="#666666">【檢查報告編號】連結</font>則可修改或查看此筆資料。</li>
