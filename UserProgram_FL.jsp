<%
//105.10.06 add 專案農貸檢查缺失追蹤管理系統UserProgram by 2295
%>
...
<%
    ...
    sqlCmd = " select  WTT03_1.program_id,WTT03_1.PROGRAM_NAME,WTT03_1.url_id,"
		   ...
		   + " and (WTT03_1.program_id like 'FL%' or WTT03_1.program_id = 'DS068W')"		
...
%>
<html><head>
<title>專案農貸檢查缺失追蹤管理系統</title>
<link rel='stylesheet' href='js/ftie4style.css'>
<script src='js/ftiens4.js'></script>
<td>&nbsp;&nbsp;<font color='red' size='2px'><b>專案農貸檢查缺失追蹤管理系統</b></font></td>
<script>
<%        
out.println("foldersTree = gFld('<font size=2>專案農貸檢查缺失追蹤管理系統</font>', ' ');");//95.10.16當沒有權限時,預設顯示該資料夾                          
