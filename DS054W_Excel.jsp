	...
	try{	      	
			...
			System.out.println("select acc_code="+selectacc_code);        		
  			...
  			/*
  			 select m_year || '/' || decode(length(m_month),'1','0','') || m_month as m_yearmonth, --資料年月
				    ...
				    guarantee_cnt_year_d,guarantee_cnt_year_w,guarantee_cnt_year_m,guarantee_cnt_year_k,guarantee_cnt_year_e,
				...
				from (
				      select m_year,m_month,
				             ...
				             sum(decode(loan_unit,'M',guarantee_cnt_year,0)) as guarantee_cnt_year_m,--本年度保證件數-臺中商銀
           ...
           /* reportUtil.createCell( wb, row, ( short )2, Utility.ISOtoBig5("列印人員：")+lguser_name, noBoderStyle );
            ...
            for(i=0;i<btnFieldList_data.size();i++){
               ...
               if(!((String)((List)btnFieldList_data.get(i)).get(0)).equals("GUARANTEE_CNT_YEAR0") && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("GUARANTEE_AMT_YEAR0")
               && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("LOAN_AMT_YEAR0") && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("GUARANTEE_BAL_YEAR0")
               && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("GUARANTEE_CNT_SUM0") && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("GUARANTEE_AMT_SUM0")
               && !((String)((List)btnFieldList_data.get(i)).get(0)).equals("LOAN_AMT_SUM0")
               ){ 
