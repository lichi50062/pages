...
<%!	private final String report_no = "MC006W" ;
	//取得所有總機構資料
...
function doSubmit(){   
  ...
  {
        this.document.forms[0].action = "/pages/MC006W_Excel.jsp";	
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*"><font color='#000000' size=4> 
                  <center>
                    <font color="#336600">農漁會信用部年報明細表</font>
                  </center>
                  </font> </td>
                <td width="180"><img src="images/banner_bg1.gif" width="180" height="17"></td>
              </tr>
          ...
          <td><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#5DA525">
              <tr> 
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr class='sbody'>
						<td>
							<img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">年報年份 :</span>                                
