<%
//108.04.10 create 全體農漁會信用部各身分別存款金額一覽表 by 2295
...
<%@ page import="com.tradevan.util.report.RptFR081W" %>
...
<%
   ...
   String filename="全體農漁會信用部各身分別存款金額一覽表.xls";
   String newfilename="";
   
   System.out.print("FR081W.S_YEAR="+S_YEAR+":S_MONTH="+S_MONTH);
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		try{
	  			...
	  			actMsg =RptFR081W.createRpt(S_YEAR,S_MONTH,Unit);
...
<%!
    private final static String report_no = "FR081W";
