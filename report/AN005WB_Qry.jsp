...
// 99.04.26 fix 修改部分程式以共用方式撰寫 by 2808
...
<%
	...
	boolean showUnit=true;//顯示金額單位
 	...
 	//取得權限
	Properties permission = ( session.getAttribute("AN005WB")==null ) ? new Properties() : (Properties)session.getAttribute("AN005WB"); 
	if(permission == null){
       System.out.println("AN005WB_Qry.permission == null");
    }else{
       System.out.println("AN005WB_Qry.permission.size ="+permission.size());               
    }
%>
...
function doSubmit(){   
	...
	this.document.forms[0].action = "/pages/report/AN005WB.jsp?act=Excel";
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><nobr>某年底縣市別之全體農漁會信用部放款金額及放款平均餘額表</nobr></font></td>
    <td width="25%"><img src="/pages/images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
