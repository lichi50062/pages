...
<%@ page import="com.tradevan.util.report.RptAN004WB"%>
...
<%
	...
	try{
	    String actMsg = RptAN004WB.createRpt(starYear,endYear,bankType,Integer.parseInt(priceUtil));
	    //System.out.println("RptAN004WB.createRpt = "+actMsg);
	    String titleStr="";
    	...
    	//System.out.println("filename="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+Utility.ISOtoBig5(titleStr+".xls"));
	   ...
	   System.out.println("//.... jsp/Report/AN004WB_Excel.jsp Have Error...");
	   ex.printStackTrace();
	   System.out.println("//.....................................");
	}
	//System.out.println("AN004WB_Excel.jsp End...");
%>