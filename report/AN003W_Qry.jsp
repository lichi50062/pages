...
<%
	Calendar rightNow = Calendar.getInstance();
   	String YEAR1  = "51";//==2006/12/19關貿提出需求變更//String.valueOf(rightNow.get(Calendar.YEAR)-1911); //回覆值為西元年故需-1911取得民國年;
   	String YEAR2  = String.valueOf((rightNow.get(Calendar.YEAR)-1911)-1); //==2006/12/19關貿提出需求變更//回覆值為西元年故需-1911取得民國年;
   	String bank_type = ( request.getParameter("bank_type")==null ) ? "" : (String)request.getParameter("bank_type");			    	
 	//取得權限
	Properties permission = ( session.getAttribute("AN003W")==null ) ? new Properties() : (Properties)session.getAttribute("AN003W"); 
	if(permission == null){
       System.out.println("AN003W_Qry.permission == null");
    }else{
       System.out.println("AN003W_Qry.permission.size ="+permission.size());               
    }
%>
...
<!--
			function doSubmit(){ 
			   ...
			   this.document.queryForm.action = "/pages/report/AN003W.jsp?act=Excel";
						...
						<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">        
							<tr> 
								<td>
									<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr> 
											<td width="50"><img src="../images/banner_bg1.gif" width="50" height="17"></td>
											<td width="*"><font color='#000000' size=4> 
												<center>
													<font color="#336600">歷年來全體農漁會逾放、本期損益、淨值、資產總額一覽表</font>
												</center>
											</font></td>
											<td width="50"><img src="../images/banner_bg1.gif" width="50" height="17"></td>
										</tr>
							...
							<tr class="sbody">
								...
								<td width="416" bgcolor="#EBF4E1" height="1">
									<select size="1" name="priceUtil">
										...
										<option value ="1000">仟元</option>
										<option value ="10000">萬元</option>
										<option value ="1000000" selected >百萬元</option>
