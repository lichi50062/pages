...
<%@ page import="com.tradevan.util.report.RptAN004W"%>
...
<%
	...
	try{
	    String actMsg = RptAN004W.createRpt(starYear,endYear,bankType,Integer.parseInt(priceUtil));
	    //System.out.println("RptAN004W.createRpt = "+actMsg);
	    String titleStr="";
    	...
    	//System.out.println("filename="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+Utility.ISOtoBig5("多個年度農漁會信用部存款結構及變動表.xls"));
	   ...
	   System.out.println("//.... jsp/Report/AN004W_Excel.jsp Have Error...");
	   ex.printStackTrace();
	   System.out.println("//.....................................");
	}
	//System.out.println("AN004W_Excel.jsp End...");
%>