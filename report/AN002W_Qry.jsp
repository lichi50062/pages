...
<%
	Calendar rightNow = Calendar.getInstance();
   	...
   	String bank_type = Utility.getTrimString(request.getParameter("bank_type") );			    	
 	//取得權限
	Properties permission = ( session.getAttribute("AN002W")==null ) ? new Properties() : (Properties)session.getAttribute("AN002W"); 
	if(permission == null){
       System.out.println("AN002W_Qry.permission == null");
    }else{
       System.out.println("AN002W_Qry.permission.size ="+permission.size());               
    }
%>
...
<!--
			function doSubmit(){ 
			   ...
			   this.document.forms[0].action = "/pages/report/AN002W.jsp?act=Excel";
									...
									<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr> 
											...
											<td width="*"><font color='#000000' size=4> 
												<center>
													<font color="#336600">歷年來全體農漁會信用部簡明放款結構比較表</font>
												</center>
											</font></td>
											<td width="100"><img src="../images/banner_bg1.gif" width="100" height="17"></td>
										</tr>
