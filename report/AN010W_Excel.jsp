...
<%@ page import="com.tradevan.util.report.RptAN010W" %>
<%@ page import="com.tradevan.util.transfer.rptTrans" %>
<%
	System.out.println("AN010W_Excel.jsp Start...");
	...
	try{
		//生成report
	    String actMsg =RptAN010W.createRpt(S_YEAR, bankType, unit);
	    System.out.println("createRpt = "+actMsg);
	    
	    FileInputStream fin = null;
	    
    	//System.out.println("filename="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+Utility.ISOtoBig5("某年底全體農漁會信用部各類財務比率.xls"));
    	String filename = "某年底全體農漁會信用部各類財務比率.xls";//108.05.28 add
	...
	System.out.println("AN010W_Excel.jsp End...");
%>
