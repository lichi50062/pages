...
<%
	Calendar rightNow = Calendar.getInstance();
   	String YEAR1  = String.valueOf((rightNow.get(Calendar.YEAR)-1911)-1); //==2006/12/19關貿提出需求變更
   	String bank_type = ( request.getParameter("bank_type")==null ) ? "" : (String)request.getParameter("bank_type");			    	
 	//取得權限
	Properties permission = ( session.getAttribute("AN007W")==null ) ? new Properties() : (Properties)session.getAttribute("AN007W"); 
	if(permission == null){
       System.out.println("AN007W_Qry.permission == null");
    }else{
       System.out.println("AN007W_Qry.permission.size ="+permission.size());               
    }
%>
...
<!--
			function doSubmit(){  
			   ...
			   this.document.queryForm.action = "/pages/report/AN007W.jsp?act=Excel";
									...
									<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr> 
											...
											<td width="*"><font color='#000000' size=4> 
												<center>
													<font color="#336600">多個年度農漁會信用部簡明損益比較表</font>
												</center>
											</font></td>
											<td width="100"><img src="../images/banner_bg1.gif" width="100" height="17"></td>
										</tr>
