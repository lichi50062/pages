...
<%@ page import="com.tradevan.util.report.RptAN007W"%>
...
<%
	...
	try{
	    String actMsg = RptAN007W.createRpt(starYear, bankType, Integer.parseInt(priceUtil));
	    //System.out.println("RptAN007W.createRpt = "+actMsg);
	    String titleStr="";
    	...
    	//System.out.println("filename="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+Utility.ISOtoBig5("多個年度農漁會信用部簡明損益比較表.xls"));
	   ...
	   System.out.println("//.... jsp/Report/AN007W_Excel.jsp Have Error...");
	   ex.printStackTrace();
	   System.out.println("//.....................................");
	}
	//System.out.println("AN007W_Excel.jsp End...");
%>