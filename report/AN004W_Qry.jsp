...
<%
	Calendar rightNow = Calendar.getInstance();
 	...
 	//取得權限
	Properties permission = ( session.getAttribute("AN004W")==null ) ? new Properties() : (Properties)session.getAttribute("AN004W"); 
	if(permission == null){
       System.out.println("AN004W_Qry.permission == null");
    }else{
       System.out.println("AN004W_Qry.permission.size ="+permission.size());               
    }
%>
...
<!--
			function doSubmit(){  
			   ...
			   this.document.queryForm.action = "/pages/report/AN004W.jsp?act=Excel";
									...
									<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr> 
											...
											<td width="*"><font color='#000000' size=4> 
												<center>
													<font color="#336600">多個年度農漁會信用部存款結構及變動表</font>
												</center>
											</font></td>
											<td width="100"><img src="../images/banner_bg1.gif" width="100" height="17"></td>
										</tr>
