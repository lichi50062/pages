...
// 99/05/11 fix 縣市合併調整與部分程式改為共用 by 2808
...
<%
	...
	System.out.println("FR033W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("FR033W_BankList.hsien_id="+hsien_id);
...
<script language="javascript" src="js/FR033W.js"></script>
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><center>全體<%=title%>委外催收委外之對象一覽表 </center></font></td>
    <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td bgcolor="#E9F4E3"> <table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">查詢年月 :</span> 						  						
                          ...
                          <tr class="sbody">                           
                            <td><img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">排序類別:</span>                                
                               <select name="rpt_type">                               
                                <option value="01">縣市別</option>
                                <option value="02">委外項目</option>                                
                              </select>
                            </td>
                          </tr>
                          <tr class="sbody">
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("FR033W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
