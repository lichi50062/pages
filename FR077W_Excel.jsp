...
<%@ page import="com.tradevan.util.report.RptFR077W" %>
...
<%
	...
	if (!Utility.CheckPermission(request, report_no)) {//無權限時,導向到LoginError.jsp
		...
		if (act.equals("download")) {
			try {
				actMsg = RptFR077W.createRpt(S_YEAR, S_MONTH, bank_type,Unit);
...
<%!
	private final static String report_no = "FR077W";
	private final static String nextPgName = "/pages/ActMsg.jsp";
	private final static String QryPgName = "/pages/FR077W_Qry.jsp";
	private final static String RptCreatePgName = "/pages/FR077W_Excel.jsp";
