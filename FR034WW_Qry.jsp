...
// 99/05/11 fix 縣市合併與部分程式改以共用方式 by 2808
// 99.11.09 fix UI縣市排序 by 2808
...
<%
	...
	String report_no  = "FR034WW" ;
	String act = Utility.getTrimString(dataMap.get("act")) ;			
	String Unit = session.getAttribute("unit")==null?"1000" : (String)session.getAttribute("unit") ;
	...
	System.out.println("FR034WW_BankList.szExcelAction="+szExcelAction);
	System.out.println("FR034WW_BankList.hsien_id="+hsien_id);
...
<script language="javascript" src="js/FR034WW.js"></script>
...
function doSubmit(form,cnd){
   if(form.rptStyle.value=='1' && cnd == 'createRpt'){      
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><center>全體<%=title%>信用部警示帳戶調查統計表 </center></font></td>
    <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr class="sbody"> 
                            <td><img src="images/2_icon_01.gif" width="16" height="16" align="absmiddle"><span class="mtext">縣市別 :</span>                                
                           		<select size="1" name="HSIEN_ID" onchange="javascript:clearSelectBlock();changeOption(document.forms[0],'');" />
                            </td>
                          </tr>
                          <tr class="sbody">
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("FR034WW_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
