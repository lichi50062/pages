...
<%@ page import="com.tradevan.util.report.RptFL011W" %>
...
<%
   ...
   String filename="逾期未函報政策性農業專案貸款缺失改善情形農漁會明細查詢表.xls";
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp
    	...
    	if(act.equals("view") || act.equals("download")){
    		...
    		try{
    			...
    			actMsg =RptFL011W.createRpt();
	 			System.out.println("=========fileName="+actMsg) ;
...
<%!
    private final static String report_no = "FL011W";
