...
<%@ page import="com.tradevan.util.report.RptTC38" %>
...
<%
   ...
   System.out.println("TC38_Excel.jsp ...Start");
...
<%
	try{
	  ...
	  String fileName = new RptTC38().createReport( body, duringDate);
	  System.out.println("TC38檔案路徑位置 ="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+fileName);
