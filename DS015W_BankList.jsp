...
//111.04.01 調整Edge無法挑選縣市別/金融機構代碼無資料可挑選 by 2295
//111.04.01 調整Edge可選擇項目,dbclick時無法將項目移至已選擇項目 by 2295
%>
...
<%
	...
	String ds_memo1 = "選取[各信用部]：按「牌告利率每季明細資料」的報表內容列印";//108.04.26 add			
        ...
        <tr> 
          <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*" class="title_font">牌告利率每月申報資料</td>
                <td width="260"><img src="images/banner_bg1.gif" width="260" height="17"></td>
              </tr>
            </table></td>
        </tr>
