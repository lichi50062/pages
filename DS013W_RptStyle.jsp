...
//99.05.25 fix 套用共用畫面DS_RptStyle.include by 2808
%>
...
<%
	...
	System.out.println("DS013W_RptStyle.szExcelAction="+szExcelAction);
        ...
        <tr> 
          <td width="824"><table width="797" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="300" class="title_font">承受擔保品延長處分申報情形資料 </td>
                <td width="220"><img src="images/banner_bg1.gif" width="220" height="17"></td>
              </tr>
            </table></td>
        </tr>
