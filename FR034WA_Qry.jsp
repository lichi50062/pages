...
<%
	Calendar rightNow = Calendar.getInstance();
 	...
 	String title="農漁會信用部警示帳戶調查統計總表.xls";
 	//取得FR023W的權限
	Properties permission = ( session.getAttribute("FR034WA")==null ) ? new Properties() : (Properties)session.getAttribute("FR034WA");
	if(permission == null){
       System.out.println("FR034WA_Qry.permission == null");
    }else{
       System.out.println("FR034WA_Qry.permission.size ="+permission.size());
    }
%>
...
function doSubmit(){
   ...
   this.document.forms[0].action = "/pages/FR034WA_Excel.jsp";
          ...
          <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="*"><font color='#000000' size=4>
                  ...
                  %>
                    <font color="#336600">全體<%=bank_name%>信用部警示帳戶調查統計總表</font>
                  </center>
                  </font> </td>
                <td width="14"><img src="images/banner_bg1.gif" width="140" height="17"></td>
              </tr>
            </table></td>
        </tr>
        <tr>
